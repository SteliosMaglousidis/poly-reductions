...
value "tree_to_rcom (rcom_tree_in_the_end (rcom_to_tree (IF n=0 ON b THEN r ::= A (N 0) ELSE ( 
                     IF n=1 ON b THEN r ::= A (N 1) ELSE ( 
                          n ::= Sub (V n) (N 1) ;;
                            CALL fib RETURN r;;
                            r1 ::= A (V r);;
                            ...
                            CALL fib RETURN r;;
                            r2 ::= A (V r);;
                            r ::= Plus (V r1) (V r2))))) \<langle>\<langle>\<rangle>,rAssigntag adsad adsasd ,\<langle>\<rangle>\<rangle>)"
