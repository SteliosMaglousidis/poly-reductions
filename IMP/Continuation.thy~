...
rlcvSeq1: "\<lbrakk>c \<turnstile>\<^sub>L\<^sub>C (c1,s1) \<Rightarrow>\<^bsup>x \<^esup> (s2,r) ; c \<turnstile>\<^sub>L\<^sub>C (c2,s2) \<Rightarrow>\<^bsup>y \<^esup> (s3,None) ; z=x+y \<rbrakk> \<Longrightarrow> c \<turnstile>\<^sub>L\<^sub>C (c1;;c2, s1) \<Rightarrow>\<^bsup>z \<^esup> (s3,r)" |
rlcvSeq2: "\<lbrakk>c \<turnstile>\<^sub>L\<^sub>C (c1,s1) \<Rightarrow>\<^bsup>x \<^esup> (s2,r) ; c \<turnstile>\<^sub>L\<^sub>C (c2,s2) \<Rightarrow>\<^bsup>y \<^esup> (s3,Some r') ; z=x+y \<rbrakk> \<Longrightarrow> c \<turnstile>\<^sub>L\<^sub>C (c1;;c2, s1) \<Rightarrow>\<^bsup>z \<^esup> (s3,Some r')" |
...
lemma last_call_value1: "c' \<turnstile>\<^sub>L\<^sub>C\<^sub>V (c,s) \<Rightarrow>\<^bsup> z \<^esup> (t, v) \<Longrightarrow> v = Some val \<Longrightarrow> \<exists>r. c' \<turnstile>\<^sub>L\<^sub>C (c,s) \<Rightarrow>\<^bsup> z \<^esup> (t,Some r)"
  ...
  using no_last_call_value1 apply blast
      apply (meson last_call_sound lcv_sound rlast_call.rlcvSeq2)
  by blast+
...
lemma last_call_value: "c' \<turnstile>\<^sub>L\<^sub>C\<^sub>V (c,s) \<Rightarrow>\<^bsup> z \<^esup> (t, v) \<Longrightarrow> v = Some val\<Longrightarrow>c' \<turnstile>\<^sub>L\<^sub>C (c,s) \<Rightarrow>\<^bsup> z \<^esup> (t, Some r) \<Longrightarrow> t r = val"
