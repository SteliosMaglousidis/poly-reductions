...
theory IMP_Minus_To_SAS_Plus_Plus_State_Translations
  imports SAS_Plus_Plus "IMP-.IMP_Minus_Small_StepT"
begin
...
next
  case 5 show ?case unfolding bot_domain_element_def using less_eq_domain_element.elims
    by (metis IMP_Minus_To_SAS_Plus_Plus_State_Translations.domain_element.exhaust bot_bit_def
