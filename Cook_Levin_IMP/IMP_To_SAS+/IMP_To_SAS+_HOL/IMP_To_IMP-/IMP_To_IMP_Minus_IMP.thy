...
definition "add_result_to_stack_aux_con_eq_three_IMP \<equiv>
...
lemma add_result_to_stack_aux_con_eq_three_IMP_correct_function:
  "(invoke_subprogram p add_result_to_stack_aux_con_eq_three_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
apply (subst add_result_to_stack_aux_con_eq_three_imp_def)
apply (simp only: add_result_to_stack_aux_con_eq_three_IMP_def prefix_simps)
apply (erule Seq_E)+
apply (erule cons_IMP_correct[where vars=add_result_to_stack_aux_IMP_vars])
subgoal premises p using p(37) by fastforce
apply (erule nth_nat_IMP_correct[where vars="add_result_to_stack_aux_IMP_vars \<union> {cons_prefix @ cons_ret_str}"])
...
lemma add_result_to_stack_aux_con_eq_three_IMP_correct_time :
  "(invoke_subprogram p add_result_to_stack_aux_con_eq_three_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
definition "add_result_to_stack_aux_con_eq_four_IMP \<equiv>
  (cons_prefix @ cons_h_str) ::= A (V add_result_to_stack_aux_c_str);;
  (cons_prefix @ cons_t_str) ::= A (N 0);;
  (cons_prefix @ cons_ret_str) ::= A (N 0);;
  invoke_subprogram cons_prefix cons_IMP;;
...
lemma add_result_to_stack_aux_con_eq_four_IMP_correct_function:
  "(invoke_subprogram p add_result_to_stack_aux_con_eq_four_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p add_result_to_stack_aux_ret_str)
      = add_result_to_stack_aux_ret
          (add_result_to_stack_aux_con_eq_four_imp (add_result_to_stack_aux_imp_to_HOL_state p s))"
apply (subst add_result_to_stack_aux_con_eq_four_imp_def)
apply (simp only: add_result_to_stack_aux_con_eq_four_IMP_def prefix_simps)
apply (erule Seq_E)+
apply (erule cons_IMP_correct[where vars=add_result_to_stack_aux_IMP_vars])
subgoal premises p using p(45) by fastforce
apply (erule nth_nat_IMP_correct[where vars="add_result_to_stack_aux_IMP_vars \<union> {cons_prefix @ cons_ret_str}"])
...
lemma add_result_to_stack_aux_con_eq_four_IMP_correct_time :
  "(invoke_subprogram p add_result_to_stack_aux_con_eq_four_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
definition "add_result_to_stack_aux_con_eq_six_IMP \<equiv>
  (cons_prefix @ cons_h_str) ::= A (V add_result_to_stack_aux_c_str);;
  (cons_prefix @ cons_t_str) ::= A (N 0);;
  (cons_prefix @ cons_ret_str) ::= A (N 0);;
  invoke_subprogram cons_prefix cons_IMP;;
...
lemma add_result_to_stack_aux_con_eq_six_IMP_correct_function:
  "(invoke_subprogram p add_result_to_stack_aux_con_eq_six_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p add_result_to_stack_aux_ret_str)
      = add_result_to_stack_aux_ret
          (add_result_to_stack_aux_con_eq_six_imp (add_result_to_stack_aux_imp_to_HOL_state p s))"
apply (subst add_result_to_stack_aux_con_eq_six_imp_def)
apply (simp only: add_result_to_stack_aux_con_eq_six_IMP_def prefix_simps)
apply (erule Seq_E)+
apply (erule cons_IMP_correct[where vars=add_result_to_stack_aux_IMP_vars])
subgoal premises p using p(45) by fastforce
apply (erule nth_nat_IMP_correct[where vars="add_result_to_stack_aux_IMP_vars \<union> {cons_prefix @ cons_ret_str}"])
...
lemma add_result_to_stack_aux_con_eq_six_IMP_correct_time :
  "(invoke_subprogram p add_result_to_stack_aux_con_eq_six_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
definition "add_result_to_stack_aux_con_eq_nine_IMP \<equiv>
  (cons_prefix @ cons_h_str) ::= A (V add_result_to_stack_aux_c_str);;
  (cons_prefix @ cons_t_str) ::= A (N 0);;
  (cons_prefix @ cons_ret_str) ::= A (N 0);;
  invoke_subprogram cons_prefix cons_IMP;;
...
lemma add_result_to_stack_aux_con_eq_nine_IMP_correct_function:
  "(invoke_subprogram p add_result_to_stack_aux_con_eq_nine_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p add_result_to_stack_aux_ret_str)
      = add_result_to_stack_aux_ret
          (add_result_to_stack_aux_con_eq_nine_imp (add_result_to_stack_aux_imp_to_HOL_state p s))"
apply (subst add_result_to_stack_aux_con_eq_nine_imp_def)
apply (simp only: add_result_to_stack_aux_con_eq_nine_IMP_def prefix_simps)
apply (erule Seq_E)+
apply (erule cons_IMP_correct[where vars=add_result_to_stack_aux_IMP_vars])
subgoal premises p using p(37) by fastforce
apply (erule nth_nat_IMP_correct[where vars="add_result_to_stack_aux_IMP_vars \<union> {cons_prefix @ cons_ret_str}"])
...
lemma add_result_to_stack_aux_con_eq_nine_IMP_correct_time :
  "(invoke_subprogram p add_result_to_stack_aux_con_eq_nine_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
definition "add_result_to_stack_aux_con_eq_seven_IMP \<equiv>
  (cons_prefix @ cons_h_str) ::= A (V add_result_to_stack_aux_c_str);;
  (cons_prefix @ cons_t_str) ::= A (N 0);;
  (cons_prefix @ cons_ret_str) ::= A (N 0);;
  invoke_subprogram cons_prefix cons_IMP;;
...
lemma add_result_to_stack_aux_con_eq_seven_IMP_correct_function:
  "(invoke_subprogram p add_result_to_stack_aux_con_eq_seven_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p add_result_to_stack_aux_ret_str)
      = add_result_to_stack_aux_ret
          (add_result_to_stack_aux_con_eq_seven_imp (add_result_to_stack_aux_imp_to_HOL_state p s))"
apply (subst add_result_to_stack_aux_con_eq_seven_imp_def)
apply (simp only: add_result_to_stack_aux_con_eq_seven_IMP_def prefix_simps)
apply (erule Seq_E)+
apply (erule cons_IMP_correct[where vars=add_result_to_stack_aux_IMP_vars])
subgoal premises p using p(53) by fastforce
apply (erule nth_nat_IMP_correct[where vars="add_result_to_stack_aux_IMP_vars \<union> {cons_prefix @ cons_ret_str}"])
...
lemma add_result_to_stack_aux_con_eq_seven_IMP_correct_time :
  "(invoke_subprogram p add_result_to_stack_aux_con_eq_seven_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
definition "add_result_to_stack_aux_sub_branch_aux1_IMP \<equiv>
  ...
  (IF add_result_to_stack_aux_cond_str\<noteq>0
   ...
   ELSE add_result_to_stack_aux_con_eq_nine_IMP)
  "

lemma add_result_to_stack_aux_sub_branch_aux1_IMP_correct_function:
  "(invoke_subprogram p add_result_to_stack_aux_sub_branch_aux1_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p add_result_to_stack_aux_ret_str)
      = add_result_to_stack_aux_ret
          (add_result_to_stack_aux_sub_branch_aux1 (add_result_to_stack_aux_imp_to_HOL_state p s))"
  apply (subst add_result_to_stack_aux_sub_branch_aux1_def)
  apply (simp only: add_result_to_stack_aux_sub_branch_aux1_IMP_def prefix_simps)
  apply (erule Seq_E)+
  apply (erule NOTEQUAL_neq_zero_IMP_correct[where vars="add_result_to_stack_aux_IMP_vars"])
  ...
  apply (erule If_E)
    ...
    subgoal
     apply (fastforce dest!: add_result_to_stack_aux_con_eq_nine_IMP_correct_function
      simp: add_result_to_stack_aux_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def Let_def)
    done
  done

lemma add_result_to_stack_aux_sub_branch_aux1_IMP_correct_time:
  "(invoke_subprogram p add_result_to_stack_aux_sub_branch_aux1_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  apply (erule If_tE)
    ...
    subgoal
     apply (fastforce dest!: add_result_to_stack_aux_con_eq_nine_IMP_correct_time
      simp: add_result_to_stack_aux_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def Let_def)
    done
  done
...
definition "add_result_to_stack_aux_sub_branch_aux2_IMP \<equiv>
  (NOTEQUAL_neq_zero_prefix @ NOTEQUAL_neq_zero_a_str) ::= A (V add_result_to_stack_aux_con_str);;
  ...
  add_result_to_stack_aux_cond_str ::= A (V (NOTEQUAL_neq_zero_prefix @ NOTEQUAL_neq_zero_ret_str));;
  (IF add_result_to_stack_aux_cond_str\<noteq>0
   THEN add_result_to_stack_aux_sub_branch_aux1_IMP
   ELSE add_result_to_stack_aux_con_eq_seven_IMP)
  "

lemma add_result_to_stack_aux_sub_branch_aux2_IMP_correct_function:
  "(invoke_subprogram p add_result_to_stack_aux_sub_branch_aux2_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p add_result_to_stack_aux_ret_str)
      = add_result_to_stack_aux_ret
          (add_result_to_stack_aux_sub_branch_aux2 (add_result_to_stack_aux_imp_to_HOL_state p s))"
  apply (subst add_result_to_stack_aux_sub_branch_aux2_def)
  apply (simp only: add_result_to_stack_aux_sub_branch_aux2_IMP_def prefix_simps)
  apply (erule Seq_E)+
  apply (erule NOTEQUAL_neq_zero_IMP_correct[where vars="add_result_to_stack_aux_IMP_vars"])
  subgoal premises p using p(6) by fastforce
  apply (erule If_E)
    subgoal
      apply (fastforce dest!: add_result_to_stack_aux_sub_branch_aux1_IMP_correct_function
         simp: add_result_to_stack_aux_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def)
    done
    subgoal
     apply (fastforce dest!: add_result_to_stack_aux_con_eq_seven_IMP_correct_function
      simp: add_result_to_stack_aux_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def Let_def)
    done
  done

lemma add_result_to_stack_aux_sub_branch_aux2_IMP_correct_time:
  "(invoke_subprogram p add_result_to_stack_aux_sub_branch_aux2_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  apply (erule If_tE)
    subgoal
      apply (force dest!: add_result_to_stack_aux_sub_branch_aux1_IMP_correct_time
       simp: add_result_to_stack_aux_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def)
    done
    subgoal
     apply (force dest!: add_result_to_stack_aux_con_eq_seven_IMP_correct_time
      simp: add_result_to_stack_aux_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def Let_def)
    done
  done
...
definition "add_result_to_stack_aux_sub_branch_aux3_IMP \<equiv>
  (NOTEQUAL_neq_zero_prefix @ NOTEQUAL_neq_zero_a_str) ::= A (V add_result_to_stack_aux_con_str);;
  ...
  add_result_to_stack_aux_cond_str ::= A (V (NOTEQUAL_neq_zero_prefix @ NOTEQUAL_neq_zero_ret_str));;
  (IF add_result_to_stack_aux_cond_str\<noteq>0
   THEN add_result_to_stack_aux_sub_branch_aux2_IMP
   ELSE add_result_to_stack_aux_con_eq_six_IMP)
  "

lemma add_result_to_stack_aux_sub_branch_aux3_IMP_correct_function:
  "(invoke_subprogram p add_result_to_stack_aux_sub_branch_aux3_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p add_result_to_stack_aux_ret_str)
      = add_result_to_stack_aux_ret
          (add_result_to_stack_aux_sub_branch_aux3 (add_result_to_stack_aux_imp_to_HOL_state p s))"
  apply (subst add_result_to_stack_aux_sub_branch_aux3_def)
  apply (simp only: add_result_to_stack_aux_sub_branch_aux3_IMP_def prefix_simps)
  apply (erule Seq_E)+
  apply (erule NOTEQUAL_neq_zero_IMP_correct[where vars="add_result_to_stack_aux_IMP_vars"])
  subgoal premises p using p(6) by fastforce
  apply (erule If_E)
    subgoal
      apply (fastforce dest!: add_result_to_stack_aux_sub_branch_aux2_IMP_correct_function
         simp: add_result_to_stack_aux_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def)
    done
    subgoal
     apply (fastforce dest!: add_result_to_stack_aux_con_eq_six_IMP_correct_function
      simp: add_result_to_stack_aux_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def Let_def)
    done
  done

lemma add_result_to_stack_aux_sub_branch_aux3_IMP_correct_time:
  "(invoke_subprogram p add_result_to_stack_aux_sub_branch_aux3_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  apply (erule If_tE)
    subgoal
      apply (fastforce dest!: add_result_to_stack_aux_sub_branch_aux2_IMP_correct_time
       simp: add_result_to_stack_aux_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def)
    done
    subgoal
     apply (force dest!: add_result_to_stack_aux_con_eq_six_IMP_correct_time
      simp: add_result_to_stack_aux_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def Let_def)
    done
  done
...
definition "add_result_to_stack_aux_sub_branch_aux4_IMP \<equiv>
  (NOTEQUAL_neq_zero_prefix @ NOTEQUAL_neq_zero_a_str) ::= A (V add_result_to_stack_aux_con_str);;
  ...
  add_result_to_stack_aux_cond_str ::= A (V (NOTEQUAL_neq_zero_prefix @ NOTEQUAL_neq_zero_ret_str));;
  (IF add_result_to_stack_aux_cond_str\<noteq>0
   THEN add_result_to_stack_aux_sub_branch_aux3_IMP
   ELSE add_result_to_stack_aux_con_eq_four_IMP)
  "

lemma add_result_to_stack_aux_sub_branch_aux4_IMP_correct_function:
  "(invoke_subprogram p add_result_to_stack_aux_sub_branch_aux4_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p add_result_to_stack_aux_ret_str)
      = add_result_to_stack_aux_ret
          (add_result_to_stack_aux_sub_branch_aux4 (add_result_to_stack_aux_imp_to_HOL_state p s))"
  apply (subst add_result_to_stack_aux_sub_branch_aux4_def)
  apply (simp only: add_result_to_stack_aux_sub_branch_aux4_IMP_def prefix_simps)
  apply (erule Seq_E)+
  apply (erule NOTEQUAL_neq_zero_IMP_correct[where vars="add_result_to_stack_aux_IMP_vars"])
  subgoal premises p using p(6) by fastforce
  apply (erule If_E)
    subgoal
      apply (fastforce dest!: add_result_to_stack_aux_sub_branch_aux3_IMP_correct_function
         simp: add_result_to_stack_aux_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def)
    done
    subgoal
     apply (fastforce dest!: add_result_to_stack_aux_con_eq_four_IMP_correct_function
      simp: add_result_to_stack_aux_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def Let_def)
    done
  done

lemma add_result_to_stack_aux_sub_branch_aux4_IMP_correct_time:
  "(invoke_subprogram p add_result_to_stack_aux_sub_branch_aux4_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  apply (erule If_tE)
    subgoal
      apply (fastforce dest!: add_result_to_stack_aux_sub_branch_aux3_IMP_correct_time
       simp: add_result_to_stack_aux_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def)
    done
    subgoal
     apply (fastforce dest!: add_result_to_stack_aux_con_eq_four_IMP_correct_time
      simp: add_result_to_stack_aux_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def Let_def)
    done
  done
...
definition "add_result_to_stack_aux_IMP \<equiv>
  (NOTEQUAL_neq_zero_prefix @ NOTEQUAL_neq_zero_a_str) ::= A (V add_result_to_stack_aux_con_str);;
  ...
  add_result_to_stack_aux_cond_str ::= A (V (NOTEQUAL_neq_zero_prefix @ NOTEQUAL_neq_zero_ret_str));;
  (IF add_result_to_stack_aux_cond_str\<noteq>0
   THEN add_result_to_stack_aux_sub_branch_aux4_IMP
   ELSE add_result_to_stack_aux_con_eq_three_IMP)
  "

lemma add_result_to_stack_aux_IMP_correct_function:
  "(invoke_subprogram p add_result_to_stack_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p add_result_to_stack_aux_ret_str)
      = add_result_to_stack_aux_ret
          (add_result_to_stack_aux_imp (add_result_to_stack_aux_imp_to_HOL_state p s))"
  apply (subst add_result_to_stack_aux_imp_def)
  apply (simp only: add_result_to_stack_aux_IMP_def prefix_simps)
  apply (erule Seq_E)+
  apply (erule NOTEQUAL_neq_zero_IMP_correct[where vars="add_result_to_stack_aux_IMP_vars"])
  subgoal premises p using p(6) by fastforce
  apply (erule If_E)
    subgoal
      apply (fastforce dest!: add_result_to_stack_aux_sub_branch_aux4_IMP_correct_function
         simp: add_result_to_stack_aux_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def)
    done
    subgoal
     apply (fastforce dest!: add_result_to_stack_aux_con_eq_three_IMP_correct_function
      simp: add_result_to_stack_aux_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def Let_def)
    done
  done

lemma add_result_to_stack_aux_IMP_correct_time:
  "(invoke_subprogram p add_result_to_stack_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  apply (erule If_tE)
    subgoal
      apply (fastforce dest!: add_result_to_stack_aux_sub_branch_aux4_IMP_correct_time
       simp: add_result_to_stack_aux_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def)
    done
    subgoal
     apply (fastforce dest!: add_result_to_stack_aux_con_eq_three_IMP_correct_time
      simp: add_result_to_stack_aux_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def Let_def)
    done
  done

lemma add_result_to_stack_aux_IMP_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) add_result_to_stack_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
  ...
  using add_result_to_stack_aux_IMP_correct_function
       add_result_to_stack_aux_IMP_correct_time
       set_mono_prefix
...
definition
  "add_result_to_stack_nat_s_eq_zero_IMP \<equiv>
...
lemma add_result_to_stack_nat_s_eq_zero_IMP_correct_function:
  "(invoke_subprogram p add_result_to_stack_nat_s_eq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
   ...
   apply (simp only: add_result_to_stack_nat_s_eq_zero_IMP_def prefix_simps)
   apply (erule Seq_E)+
   apply (erule cons_IMP_correct[where vars=add_result_to_stack_nat_IMP_vars])
...
lemma add_result_to_stack_nat_s_eq_zero_IMP_correct_time :
  "(invoke_subprogram p add_result_to_stack_nat_s_eq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
definition "add_result_to_stack_nat_else_aux_IMP \<equiv>
...
lemma add_result_to_stack_nat_else_aux_IMP_correct_h:
  "(invoke_subprogram p add_result_to_stack_nat_else_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
    ...
    apply (subst add_result_to_stack_nat_else_aux_imp_def)
    apply (simp only: add_result_to_stack_nat_else_aux_IMP_def prefix_simps)
    apply (erule Seq_E)+
    apply (erule hd_IMP_correct[where vars = add_result_to_stack_nat_else_aux_IMP_vars])
    ...
    apply (erule tl_IMP_correct[where vars = "add_result_to_stack_nat_else_aux_IMP_vars
...
lemma add_result_to_stack_nat_else_aux_IMP_correct_con:
  "(invoke_subprogram p add_result_to_stack_nat_else_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma add_result_to_stack_nat_else_aux_IMP_correct_t:
  "(invoke_subprogram p add_result_to_stack_nat_else_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  lemma add_result_to_stack_nat_else_aux_IMP_correct_time:
  "(invoke_subprogram p add_result_to_stack_nat_else_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma add_result_to_stack_nat_else_aux_IMP_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) add_result_to_stack_nat_else_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (add_result_to_stack_nat_else_aux_imp_time 0 (add_result_to_stack_nat_else_aux_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using add_result_to_stack_nat_else_aux_IMP_correct_h
        add_result_to_stack_nat_else_aux_IMP_correct_con
        add_result_to_stack_nat_else_aux_IMP_correct_t
       add_result_to_stack_nat_else_aux_IMP_correct_time
       set_mono_prefix
  by (smt (verit, ccfv_SIG) com_add_prefix_valid_subset com_only_vars)
...
definition "add_result_to_stack_nat_else_IMP \<equiv>
  ...
  (add_result_to_stack_nat_else_aux_prefix @ add_result_to_stack_nat_else_aux_t_str)
    ::= A (N 0);;
  invoke_subprogram add_result_to_stack_nat_else_aux_prefix add_result_to_stack_nat_else_aux_IMP;;
  ...
  (add_result_to_stack_aux_prefix @ add_result_to_stack_aux_ret_str)
    ::= A (N 0);;
  invoke_subprogram add_result_to_stack_aux_prefix add_result_to_stack_aux_IMP;;
  (add_result_to_stack_nat_ret_str) ::= A (V (add_result_to_stack_aux_prefix @ add_result_to_stack_aux_ret_str))
  "

lemma add_result_to_stack_nat_else_IMP_correct_function:
"(invoke_subprogram p add_result_to_stack_nat_else_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p add_result_to_stack_nat_ret_str)
      = add_result_to_stack_nat_ret
          (add_result_to_stack_nat_else_imp (add_result_to_stack_nat_imp_to_HOL_state p s))"
apply (subst add_result_to_stack_nat_else_imp_def)
apply (simp only: add_result_to_stack_nat_else_IMP_def prefix_simps)
apply (erule Seq_E)+
apply (erule add_result_to_stack_nat_else_aux_IMP_correct[where vars=add_result_to_stack_nat_IMP_vars])
subgoal premises p using p(14) by fastforce
apply (erule add_result_to_stack_aux_IMP_correct[where vars=add_result_to_stack_nat_IMP_vars])
...
lemma add_result_to_stack_nat_else_IMP_correct_time:
"(invoke_subprogram p add_result_to_stack_nat_else_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
definition "add_result_to_stack_nat_IMP \<equiv>
  add_result_to_stack_nat_cond_str ::= A (V add_result_to_stack_nat_s_str);;
  (IF add_result_to_stack_nat_cond_str \<noteq>0
  THEN add_result_to_stack_nat_else_IMP
  ELSE add_result_to_stack_nat_s_eq_zero_IMP)"


lemma add_result_to_stack_nat_IMP_correct_function:
  "(invoke_subprogram p add_result_to_stack_nat_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p add_result_to_stack_nat_ret_str)
      = add_result_to_stack_nat_ret
          (add_result_to_stack_nat_imp (add_result_to_stack_nat_imp_to_HOL_state p s))"
  apply (subst add_result_to_stack_nat_imp_def)
  apply (simp only: add_result_to_stack_nat_IMP_def prefix_simps)
  apply (erule Seq_E)+
    apply (erule If_E)
    subgoal
      apply (fastforce dest!: add_result_to_stack_nat_else_IMP_correct_function
      simp: add_result_to_stack_nat_imp_to_HOL_state_def Let_def)
    done
    subgoal
     apply (fastforce dest!: add_result_to_stack_nat_s_eq_zero_IMP_correct_function
      simp: add_result_to_stack_nat_imp_to_HOL_state_def Let_def)
    done
  done

lemma add_result_to_stack_nat_IMP_correct_time:
  "(invoke_subprogram p add_result_to_stack_nat_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  apply (erule Seq_tE)+
    apply (erule If_tE)
    subgoal
      apply (fastforce dest!: add_result_to_stack_nat_else_IMP_correct_time
      simp: add_result_to_stack_nat_imp_to_HOL_state_def Let_def)
    done
    subgoal
     apply (fastforce dest!: add_result_to_stack_nat_s_eq_zero_IMP_correct_time
      simp: add_result_to_stack_nat_imp_to_HOL_state_def Let_def)
    done
  done

lemma add_result_to_stack_nat_IMP_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) add_result_to_stack_nat_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (add_result_to_stack_nat_imp_time 0 (add_result_to_stack_nat_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using add_result_to_stack_nat_IMP_correct_function
       add_result_to_stack_nat_IMP_correct_time
       set_mono_prefix
  by (smt (verit, ccfv_SIG) com_add_prefix_valid_subset com_only_vars)
...
definition "push_on_stack_nat_eq_zero_IMP \<equiv>
...
lemma push_on_stack_nat_eq_zero_IMP_correct_function:
  "(invoke_subprogram p push_on_stack_nat_eq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
   ...
   apply (simp only: push_on_stack_nat_eq_zero_IMP_def prefix_simps)
   apply (erule Seq_E)+
   apply (erule cons_IMP_correct[where vars=push_on_stack_nat_IMP_vars])
   subgoal premises p using p(13) by fastforce
   apply (erule cons_IMP_correct[where vars=push_on_stack_nat_IMP_vars])
   subgoal premises p using p(15) by fastforce
   apply (erule cons_IMP_correct[where vars=push_on_stack_nat_IMP_vars])
...
lemma push_on_stack_nat_eq_zero_IMP_correct_time:
  "(invoke_subprogram p push_on_stack_nat_eq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
definition "push_on_stack_nat_eq_one_IMP \<equiv>
  (cons_prefix @ cons_h_str) ::= A (V push_on_stack_nat_n_str);;
  (cons_prefix @ cons_t_str) ::= A (N 0);;
  (cons_prefix @ cons_ret_str) ::= A (N 0);;
  invoke_subprogram cons_prefix cons_IMP;;
...
lemma push_on_stack_nat_eq_one_IMP_correct_function:
  "(invoke_subprogram p push_on_stack_nat_eq_one_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p push_on_stack_nat_ret_str)
      = push_on_stack_nat_ret
          (push_on_stack_nat_eq_one (push_on_stack_nat_imp_to_HOL_state p s))"
   apply (subst push_on_stack_nat_eq_one_def)
   apply (simp only: push_on_stack_nat_eq_one_IMP_def prefix_simps)
   apply (erule Seq_E)+
   apply (erule cons_IMP_correct[where vars=push_on_stack_nat_IMP_vars_eq_one])
   subgoal premises p using p(31) by fastforce
   apply (erule nth_nat_IMP_correct[where vars=push_on_stack_nat_IMP_vars_eq_one])
...
lemma push_on_stack_nat_eq_one_IMP_correct_time:
  "(invoke_subprogram p push_on_stack_nat_eq_one_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
definition "push_on_stack_nat_eq_two_IMP \<equiv>
  (cons_prefix @ cons_h_str) ::= A (V push_on_stack_nat_n_str);;
  (cons_prefix @ cons_t_str) ::= A (N 0);;
  (cons_prefix @ cons_ret_str) ::= A (N 0);;
  invoke_subprogram cons_prefix cons_IMP;;
...
lemma push_on_stack_nat_eq_two_IMP_correct_function:
  "(invoke_subprogram p push_on_stack_nat_eq_two_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p push_on_stack_nat_ret_str)
      = push_on_stack_nat_ret
          (push_on_stack_nat_eq_two (push_on_stack_nat_imp_to_HOL_state p s))"
   apply (subst push_on_stack_nat_eq_two_def)
   apply (simp only: push_on_stack_nat_eq_two_IMP_def prefix_simps)
   apply (erule Seq_E)+
   apply (erule cons_IMP_correct[where vars=push_on_stack_nat_IMP_vars_eq_two])
   subgoal premises p using p(31) by fastforce
   apply (erule nth_nat_IMP_correct[where vars=push_on_stack_nat_IMP_vars_eq_two])
   subgoal premises p using p(33) by fastforce
   apply (erule nth_nat_IMP_correct[where vars=push_on_stack_nat_IMP_vars_eq_two])
   subgoal premises p using p(35) by fastforce
   apply (erule cons_IMP_correct[where vars=push_on_stack_nat_IMP_vars_eq_two])
...
lemma push_on_stack_nat_eq_two_IMP_correct_time:
  "(invoke_subprogram p push_on_stack_nat_eq_two_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
definition "push_on_stack_nat_else_IMP \<equiv>
  (cons_prefix @ cons_h_str) ::= A (V push_on_stack_nat_n_str);;
  (cons_prefix @ cons_t_str) ::= A (N 0);;
  (cons_prefix @ cons_ret_str) ::= A (N 0);;
  invoke_subprogram cons_prefix cons_IMP;;
...
lemma push_on_stack_nat_else_IMP_correct_function:
  "(invoke_subprogram p push_on_stack_nat_else_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p push_on_stack_nat_ret_str)
      = push_on_stack_nat_ret
          (push_on_stack_nat_else (push_on_stack_nat_imp_to_HOL_state p s))"
   apply (subst push_on_stack_nat_else_def)
   apply (simp only: push_on_stack_nat_else_IMP_def prefix_simps)
   apply (erule Seq_E)+
   apply (erule cons_IMP_correct[where vars=push_on_stack_nat_IMP_vars_else])
   subgoal premises p using p(31) by fastforce
   apply (erule nth_nat_IMP_correct[where vars=push_on_stack_nat_IMP_vars_else])
   subgoal premises p using p(33) by fastforce
   apply (erule nth_nat_IMP_correct[where vars=push_on_stack_nat_IMP_vars_else])
   subgoal premises p using p(35) by fastforce
   apply (erule cons_IMP_correct[where vars=push_on_stack_nat_IMP_vars_else])
...
lemma push_on_stack_nat_else_IMP_correct_time:
  "(invoke_subprogram p push_on_stack_nat_else_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
definition "push_on_stack_nat_eq_three_IMP \<equiv>
  (cons_prefix @ cons_h_str) ::= A (V push_on_stack_nat_n_str);;
  (cons_prefix @ cons_t_str) ::= A (N 0);;
  (cons_prefix @ cons_ret_str) ::= A (N 0);;
  invoke_subprogram cons_prefix cons_IMP;;
...
lemma push_on_stack_nat_eq_three_IMP_correct_function:
  "(invoke_subprogram p push_on_stack_nat_eq_three_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p push_on_stack_nat_ret_str)
      = push_on_stack_nat_ret
          (push_on_stack_nat_eq_three (push_on_stack_nat_imp_to_HOL_state p s))"
   apply (subst push_on_stack_nat_eq_three_def)
   apply (simp only: push_on_stack_nat_eq_three_IMP_def prefix_simps)
   apply (erule Seq_E)+
   apply (erule cons_IMP_correct[where vars=push_on_stack_nat_IMP_vars_eq_three])
   subgoal premises p using p(40) by fastforce
   apply (erule nth_nat_IMP_correct[where vars=push_on_stack_nat_IMP_vars_eq_three])
...
lemma push_on_stack_nat_eq_three_IMP_correct_time:
  "(invoke_subprogram p push_on_stack_nat_eq_three_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
definition "push_on_stack_nat_sub_branch_aux1_IMP \<equiv>
  ...
  (IF push_on_stack_nat_cond_three \<noteq>0
    THEN push_on_stack_nat_else_IMP
    ELSE push_on_stack_nat_eq_two_IMP)
  "
...
lemma push_on_stack_nat_sub_branch_aux1_IMP_correct_function:
  "(invoke_subprogram p push_on_stack_nat_sub_branch_aux1_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p push_on_stack_nat_ret_str)
      = push_on_stack_nat_ret
          (push_on_stack_nat_sub_branch_aux1 (push_on_stack_nat_imp_to_HOL_state p s))"
  apply (subst push_on_stack_nat_sub_branch_aux1_def)
  apply (simp only: push_on_stack_nat_sub_branch_aux1_IMP_def prefix_simps)
  apply (erule Seq_E)+
  apply (erule hd_IMP_correct[where vars=push_on_stack_nat_IMP_vars])
  subgoal premises p using p(10) by fastforce
  apply (erule NOTEQUAL_neq_zero_IMP_correct[where vars=push_on_stack_nat_IMP_vars])
  subgoal premises p using p(12) by fastforce
  apply (erule If_E)
    subgoal
      apply (fastforce dest!: push_on_stack_nat_else_IMP_correct_function
      simp: push_on_stack_nat_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def
          hd_imp_to_HOL_state_def Let_def)
    done
    subgoal
     apply (fastforce dest!: push_on_stack_nat_eq_two_IMP_correct_function
      simp: push_on_stack_nat_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def
          hd_imp_to_HOL_state_def Let_def)
    done
  done

lemma push_on_stack_nat_sub_branch_aux1_IMP_correct_time:
  "(invoke_subprogram p push_on_stack_nat_sub_branch_aux1_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  apply (erule If_tE)
    subgoal
      apply (fastforce dest!: push_on_stack_nat_else_IMP_correct_time
      simp: push_on_stack_nat_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def
          hd_imp_to_HOL_state_def Let_def)
    done
    subgoal
     apply (fastforce dest!: push_on_stack_nat_eq_two_IMP_correct_time
      simp: push_on_stack_nat_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def
          hd_imp_to_HOL_state_def Let_def)
    done
  done
...
definition "push_on_stack_nat_sub_branch_aux2_IMP \<equiv>
  (hd_prefix @ hd_xs_str) ::= A (V push_on_stack_nat_c_str);;
  (hd_prefix @ hd_ret_str) ::= A (N 0);;
  invoke_subprogram hd_prefix hd_IMP;;
  push_on_stack_nat_hd_c ::= A (V (hd_prefix @ hd_ret_str));;
  ...
  THEN push_on_stack_nat_sub_branch_aux1_IMP
  ELSE push_on_stack_nat_eq_one_IMP)"


lemma push_on_stack_nat_sub_branch_aux2_IMP_correct_function:
  "(invoke_subprogram p push_on_stack_nat_sub_branch_aux2_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p push_on_stack_nat_ret_str)
      = push_on_stack_nat_ret
          (push_on_stack_nat_sub_branch_aux2 (push_on_stack_nat_imp_to_HOL_state p s))"
  apply (subst push_on_stack_nat_sub_branch_aux2_def)
  apply (simp only: push_on_stack_nat_sub_branch_aux2_IMP_def prefix_simps)
  apply (erule Seq_E)+
  apply (erule hd_IMP_correct[where vars=push_on_stack_nat_IMP_vars])
  subgoal premises p using p(10) by fastforce
  apply (erule NOTEQUAL_neq_zero_IMP_correct[where vars=push_on_stack_nat_IMP_vars])
  ...
  apply (erule If_E)
    subgoal
      apply (fastforce dest!: push_on_stack_nat_sub_branch_aux1_IMP_correct_function
      simp: push_on_stack_nat_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def
      hd_imp_to_HOL_state_def Let_def)
    done
    subgoal
    apply (fastforce dest!: push_on_stack_nat_eq_one_IMP_correct_function
      simp: push_on_stack_nat_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def
      hd_imp_to_HOL_state_def Let_def)
    done
  done
...
lemma push_on_stack_nat_sub_branch_aux2_IMP_correct_time:
  "(invoke_subprogram p push_on_stack_nat_sub_branch_aux2_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  apply (erule If_tE)
    subgoal
    apply (fastforce dest!: push_on_stack_nat_sub_branch_aux1_IMP_correct_time simp:
            push_on_stack_nat_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def Let_def
            hd_imp_to_HOL_state_def)
    done
    subgoal
    apply (fastforce dest!: push_on_stack_nat_eq_one_IMP_correct_time simp:
            push_on_stack_nat_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def Let_def
            hd_imp_to_HOL_state_def)
    done
  done
...
definition "push_on_stack_nat_sub_branch_aux3_IMP \<equiv>
  (hd_prefix @ hd_xs_str) ::= A (V push_on_stack_nat_c_str);;
  (hd_prefix @ hd_ret_str) ::= A (N 0);;
  invoke_subprogram hd_prefix hd_IMP;;
  push_on_stack_nat_hd_c ::= A (V (hd_prefix @ hd_ret_str));;
  ...
  (IF push_on_stack_nat_cond_one \<noteq>0
  THEN push_on_stack_nat_sub_branch_aux2_IMP
  ELSE push_on_stack_nat_eq_three_IMP)"
...
lemma push_on_stack_nat_sub_branch_aux3_IMP_correct_function:
  "(invoke_subprogram p push_on_stack_nat_sub_branch_aux3_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p push_on_stack_nat_ret_str)
      = push_on_stack_nat_ret
          (push_on_stack_nat_sub_branch_aux3 (push_on_stack_nat_imp_to_HOL_state p s))"
  apply (subst push_on_stack_nat_sub_branch_aux3_def)
  apply (simp only: push_on_stack_nat_sub_branch_aux3_IMP_def prefix_simps)
  apply (erule Seq_E)+
  apply (erule hd_IMP_correct[where vars=push_on_stack_nat_IMP_vars])
  subgoal premises p using p(10) by fastforce
  apply (erule NOTEQUAL_neq_zero_IMP_correct[where vars=push_on_stack_nat_IMP_vars])
  ...
  apply (erule If_E)
    subgoal
      apply (fastforce dest!:push_on_stack_nat_sub_branch_aux2_IMP_correct_function simp:
      Let_def hd_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def push_on_stack_nat_imp_to_HOL_state_def)
      done
    subgoal
    apply (fastforce dest!:push_on_stack_nat_eq_three_IMP_correct_function simp:
      Let_def hd_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def push_on_stack_nat_imp_to_HOL_state_def)
    done
  done

lemma push_on_stack_nat_sub_branch_aux3_IMP_correct_time:
  "(invoke_subprogram p push_on_stack_nat_sub_branch_aux3_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  apply (erule If_tE)
    subgoal
      apply (fastforce dest!:push_on_stack_nat_sub_branch_aux2_IMP_correct_time simp:
      Let_def hd_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def push_on_stack_nat_imp_to_HOL_state_def)
      done
    subgoal
    apply (fastforce dest!:push_on_stack_nat_eq_three_IMP_correct_time simp:
      Let_def hd_imp_to_HOL_state_def NOTEQUAL_neq_zero_imp_to_HOL_state_def push_on_stack_nat_imp_to_HOL_state_def)
    done
  done
...
definition "push_on_stack_nat_IMP \<equiv>
 (hd_prefix @ hd_xs_str) ::= A (V push_on_stack_nat_c_str);;
 (hd_prefix @ hd_ret_str) ::= A (N 0);;
 invoke_subprogram hd_prefix hd_IMP;;
 push_on_stack_nat_hd_c ::= A (V (hd_prefix @ hd_ret_str));;
 IF push_on_stack_nat_hd_c \<noteq>0
  THEN  push_on_stack_nat_sub_branch_aux3_IMP
  ELSE push_on_stack_nat_eq_zero_IMP"
...
lemma push_on_stack_nat_IMP_correct_function:
  "(invoke_subprogram p push_on_stack_nat_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p push_on_stack_nat_ret_str)
      = push_on_stack_nat_ret
          (push_on_stack_nat_imp (push_on_stack_nat_imp_to_HOL_state p s))"
  apply (subst push_on_stack_nat_imp.simps)
  apply (simp only: push_on_stack_nat_IMP_def prefix_simps)
  apply (erule Seq_E)+
  apply (erule hd_IMP_correct[where vars=push_on_stack_nat_IMP_vars])
  subgoal premises p using p(5) by fastforce
  apply (erule If_E)
    subgoal
      apply (fastforce dest!:push_on_stack_nat_sub_branch_aux3_IMP_correct_function simp:
      push_on_stack_nat_state_upd_def Let_def hd_imp_to_HOL_state_def push_on_stack_nat_imp_to_HOL_state_def)
      done
    subgoal
    apply (fastforce dest!:push_on_stack_nat_eq_zero_IMP_correct_function simp:
      push_on_stack_nat_state_upd_def Let_def hd_imp_to_HOL_state_def push_on_stack_nat_imp_to_HOL_state_def)
    done
  done

lemma push_on_stack_nat_IMP_correct_time:
  "(invoke_subprogram p push_on_stack_nat_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  apply (erule If_tE)
    subgoal
      apply (fastforce dest!:push_on_stack_nat_sub_branch_aux3_IMP_correct_time
      simp: push_on_stack_nat_state_upd_time_def
      Let_def hd_imp_to_HOL_state_def push_on_stack_nat_imp_to_HOL_state_def)
      done
    subgoal
    apply (fastforce dest!:push_on_stack_nat_eq_zero_IMP_correct_time simp:
      push_on_stack_nat_state_upd_time_def Let_def hd_imp_to_HOL_state_def push_on_stack_nat_imp_to_HOL_state_def)
    done
  done

lemma push_on_stack_nat_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ push_on_stack_nat_prefix) push_on_stack_nat_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
...
lemma push_on_stack_nat_IMP_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) push_on_stack_nat_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (push_on_stack_nat_imp_time 0 (push_on_stack_nat_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using push_on_stack_nat_IMP_correct_function
       push_on_stack_nat_IMP_correct_time
       push_on_stack_nat_IMP_correct_effects set_mono_prefix
  by (smt (verit, ccfv_SIG) com_add_prefix_valid_subset com_only_vars)
...
definition  "map_var_bit_to_var_aux_IMP \<equiv>
  ...
  invoke_subprogram var_bit_to_var_tail_prefix var_bit_to_var_tail_IMP;;
...
lemma map_var_bit_to_var_aux_IMP_correct_function_ret:
  "(invoke_subprogram p map_var_bit_to_var_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
apply (simp only: map_var_bit_to_var_aux_IMP_def prefix_simps)
apply (erule Seq_E)+
apply (erule  hd_IMP_correct[where vars=map_var_bit_to_var_aux_IMP_vars])
subgoal premises p using p(19) by fastforce
apply (erule  prod_encode_IMP_correct[where vars=map_var_bit_to_var_aux_IMP_vars])
subgoal premises p using p(21) by fastforce
apply (erule  var_bit_to_var_tail_IMP_correct[where vars=map_var_bit_to_var_aux_IMP_vars])
subgoal premises p using p(23) by fastforce
apply (erule  cons_IMP_correct[where vars=map_var_bit_to_var_aux_IMP_vars])
subgoal premises p using p(25) by fastforce
apply (erule  tl_IMP_correct[where vars="map_var_bit_to_var_aux_IMP_vars"])
subgoal premises p using p(27) by fastforce
...
lemma map_var_bit_to_var_aux_IMP_correct_function_n:
  "(invoke_subprogram p map_var_bit_to_var_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma map_var_bit_to_var_aux_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ map_var_bit_to_var_aux_pref) map_var_bit_to_var_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
...
lemma map_var_bit_to_var_aux_IMP_correct_time:
  "(invoke_subprogram p map_var_bit_to_var_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma map_var_bit_to_var_aux_IMP_correct[functional_correctness]:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) map_var_bit_to_var_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (map_var_bit_to_var_aux_imp_time 0 (map_var_bit_to_var_aux_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using map_var_bit_to_var_aux_IMP_correct_function_ret
  map_var_bit_to_var_aux_IMP_correct_function_n
  by (auto simp: map_var_bit_to_var_aux_IMP_correct_time)
    (meson map_var_bit_to_var_aux_IMP_correct_effects set_mono_prefix)
...
definition "map_var_bit_to_var_acc_IMP_loop_body \<equiv>
 ...
 (map_var_bit_to_var_aux_prefix @ map_var_bit_to_var_aux_ret_str)
   ::= A (N 0);;
 invoke_subprogram map_var_bit_to_var_aux_prefix map_var_bit_to_var_aux_IMP;;
...
definition map_var_bit_to_var_acc_IMP where
  "map_var_bit_to_var_acc_IMP \<equiv>
...
lemma map_var_bit_to_var_acc_IMP_correct_function:
  "(invoke_subprogram p map_var_bit_to_var_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  apply(subst map_var_bit_to_var_acc_imp.simps)
  apply(simp only: map_var_bit_to_var_acc_IMP_def prefix_simps)
  apply(erule Seq_E)+
  ...
  subgoal
      ...
      apply(erule Seq_E)+
      apply(erule map_var_bit_to_var_aux_IMP_correct[where vars = "map_var_bit_to_var_acc_IMP_vars"])
      subgoal premises p using p(12) by fastforce
...
lemma map_var_bit_to_var_acc_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ map_var_bit_to_var_acc_pref) map_var_bit_to_var_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
...
lemma map_var_bit_to_var_acc_IMP_correct_time:
  "(invoke_subprogram p map_var_bit_to_var_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma map_var_bit_to_var_acc_IMP_correct[functional_correctness]:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) map_var_bit_to_var_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (map_var_bit_to_var_acc_imp_time 0 (map_var_bit_to_var_acc_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using map_var_bit_to_var_acc_IMP_correct_function
  by (auto simp: map_var_bit_to_var_acc_IMP_correct_time)
    (meson map_var_bit_to_var_acc_IMP_correct_effects set_mono_prefix)
...
definition "map_var_bit_to_var_tail_IMP \<equiv>
 ...
 invoke_subprogram map_var_bit_to_var_acc_prefix map_var_bit_to_var_acc_IMP;;
...
lemma map_var_bit_to_var_tail_IMP_correct_function:
"(invoke_subprogram p map_var_bit_to_var_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
apply (simp only: map_var_bit_to_var_tail_IMP_def prefix_simps)
apply (erule Seq_E)+
apply (erule map_var_bit_to_var_acc_IMP_correct[where vars=map_var_bit_to_var_tail_IMP_vars])
subgoal premises p using p(9) by fastforce
apply (erule reverse_nat_IMP_correct[where vars=map_var_bit_to_var_tail_IMP_vars])
subgoal premises p using p(11) by fastforce
apply (clarsimp simp add: map_var_bit_to_var_tail_state_translators Let_def
 map_var_bit_to_var_tail_imp.simps)
done

lemma map_var_bit_to_var_tail_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ map_var_bit_to_var_tail_pref) map_var_bit_to_var_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
...
lemma map_var_bit_to_var_tail_IMP_correct_time:
  "(invoke_subprogram p map_var_bit_to_var_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
apply (erule map_var_bit_to_var_acc_IMP_correct[where vars=map_var_bit_to_var_tail_IMP_vars])
subgoal premises p using p(17) by fastforce
apply (erule reverse_nat_IMP_correct[where vars=map_var_bit_to_var_aux_IMP_vars])
subgoal premises p using p(19) by fastforce
apply (force simp: map_var_bit_to_var_tail_imp_time.simps
  Let_def map_var_bit_to_var_tail_state_translators)
done

lemma map_var_bit_to_var_tail_IMP_correct[functional_correctness]:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) map_var_bit_to_var_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (map_var_bit_to_var_tail_imp_time 0 (map_var_bit_to_var_tail_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using map_var_bit_to_var_tail_IMP_correct_function
   map_var_bit_to_var_tail_IMP_correct_time
...
definition var_bit_list_tail_IMP where
  "var_bit_list_tail_IMP \<equiv>
  (list_less_tail_prefix @ list_less_tail_n_str) ::= A (V var_bit_list_tail_n_str);;
  (list_less_tail_prefix @ list_less_tail_ret_str) ::= A (N 0);;
  invoke_subprogram list_less_tail_prefix list_less_tail_IMP;;
  ...
  (map_var_bit_to_var_tail_prefix @ map_var_bit_to_var_tail_ret_str)
    ::= A (N 0);;
  invoke_subprogram map_var_bit_to_var_tail_prefix map_var_bit_to_var_tail_IMP;;
...
lemma var_bit_list_tail_IMP_correct_function:
  "(invoke_subprogram p var_bit_list_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  apply(simp only: var_bit_list_tail_IMP_def prefix_simps)
  apply(erule Seq_E)+
  apply(erule list_less_tail_IMP_correct[where vars = "var_bit_list_tail_IMP_vars"])
  subgoal premises p using p(8) by fastforce
  apply(erule map_var_bit_to_var_tail_IMP_correct[where vars = "var_bit_list_tail_IMP_vars"])
  subgoal premises p using p(10) by fastforce
  by(fastforce simp: var_bit_list_tail_state_translators
    var_bit_list_tail_state_upd_def)

lemma var_bit_list_tail_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ var_bit_list_tail_pref) var_bit_list_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    v \<in> vars; \<not> (prefix var_bit_list_tail_pref v)\<rbrakk>
   \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma var_bit_list_tail_IMP_correct_time:
  "(invoke_subprogram p var_bit_list_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma var_bit_list_tail_IMP_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) var_bit_list_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (var_bit_list_tail_imp_time 0 (var_bit_list_tail_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using var_bit_list_tail_IMP_correct_function
    var_bit_list_tail_IMP_correct_time
    var_bit_list_tail_IMP_correct_effects
