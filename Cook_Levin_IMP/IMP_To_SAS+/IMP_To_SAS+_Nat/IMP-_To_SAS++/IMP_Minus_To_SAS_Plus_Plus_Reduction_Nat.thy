theory IMP_Minus_To_SAS_Plus_Plus_Reduction_Nat
  imports 
    Primitives IMP_Minus_To_SAS_Plus_Plus_State_Translations_Nat  IMP_Minus_Subprograms_Nat
 "IMP_To_SAS+_HOL.IMP_Minus_To_SAS_Plus_Plus_Reduction"  
begin                               
