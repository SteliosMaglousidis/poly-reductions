theory Binary_Operations_Nat                                    
  imports "IMP_To_SAS+_HOL.Binary_Operations" Primitives Binary_Arithmetic_Nat
          IMP_To_IMP_Minus_State_Translations_Nat
          IMP_Max_Constant_Nat
begin
...
definition comm_list_encode :: "IMP_Minus_com list \<Rightarrow> nat" where
  "comm_list_encode xs = list_encode (map comm_encode xs)"

definition comm_list_decode :: "nat \<Rightarrow> IMP_Minus_com list" where
