theory Primitives
  imports
    ...
    IMP.Com
    "IMP_To_SAS+_HOL.IMP_Minus_Com"
    "HOL.String"
    "Verified_SAT_Based_AI_Planning.SAT_Plan_Base"
    "Verified_SAT_Based_AI_Planning.STRIPS_Representation"
    "IMP_To_SAS+_HOL.SAS_Plus_Plus"
    "HOL-Library.Mapping"
    "IMP_To_SAS+_HOL.SAS_Plus_Plus_To_SAS_Plus"
    "IMP_To_SAS+_HOL.IMP_Minus_To_SAS_Plus_Plus_State_Translations"
begin
