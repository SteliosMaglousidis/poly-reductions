...
theory Primitives_IMP
  imports
    "HOL-Library.Nat_Bijection"
    "IMP_To_SAS+_Nat.Primitives" IMP.Call_By_Prefixes
    "HOL-Library.Sublist"
    "IMP_To_SAS+_HOL.Utilities"
    (* Merge those *)
    Triangle_Extensions
begin
...
(*
  Disable syntax for IMP_Minus programs. This prevents parsing becoming exponential.
*)
...
lemma mul_IMP_correct_time:
  "(invoke_subprogram p mul_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
    t = (mul_imp_time 0 (mul_imp_to_HOL_state p s))"
  apply(induction "mul_imp_to_HOL_state p s" arbitrary: s s' t rule: mul_imp.induct)
  apply(simp only: mul_IMP_def com_add_prefix.simps)
...
lemma mul_IMP_correct_function:
  "(invoke_subprogram p mul_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma mul_IMP_correct_effects:
  "(invoke_subprogram (p @ mul_pref) mul_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma mul_IMP_correct[functional_correctness]:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) mul_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
  ...
  using mul_IMP_correct_time mul_IMP_correct_function mul_IMP_correct_effects
...
definition square_IMP where
  ...
  (
   ...
   invoke_subprogram mul_prefix mul_IMP;;
...
lemma square_IMP_correct_function:
  "(invoke_subprogram p square_IMP, s) \<Rightarrow>\<^bsup>t \<^esup> s' \<Longrightarrow>
  ...
  apply(simp only: square_IMP_def prefix_simps)
...
lemma square_IMP_correct_time:
  "(invoke_subprogram p square_IMP, s)
...
lemma square_IMP_correct_effects:
  "(invoke_subprogram (p @ square_pref) square_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma square_IMP_correct[functional_correctness]:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) square_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (prefix p2 v);
     \<lbrakk>t = (square_imp_time 0 (square_imp_to_HOL_state (p1 @ p2) s));
      ...
      \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
     \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using square_IMP_correct_time square_IMP_correct_function
    square_IMP_correct_effects
  by auto
...
definition dsqrt'_IMP_while_condition where
  "dsqrt'_IMP_while_condition \<equiv>
  ''inc'' ::= ((V dsqrt'_L_str) \<oplus> (N 1));;
  ''diff'' ::= ((V dsqrt'_R_str) \<ominus> (V ''inc''))"

definition dsqrt'_IMP_loop_body where
  "dsqrt'_IMP_loop_body =
    ...
    invoke_subprogram square_prefix square_IMP;;
...
definition dsqrt'_IMP_after_loop where
  "dsqrt'_IMP_after_loop = Com.SKIP"

definition dsqrt'_IMP where
  "dsqrt'_IMP \<equiv>
  \<comment> \<open>if L+1 < R\<close>
  dsqrt'_IMP_while_condition;;
  WHILE ''diff''\<noteq>0 DO (
    dsqrt'_IMP_loop_body;;
    dsqrt'_IMP_while_condition
  );;
  dsqrt'_IMP_after_loop"

lemmas dsqrt'_IMP_subprogram_simps =
  dsqrt'_IMP_while_condition_def
  dsqrt'_IMP_loop_body_def
  dsqrt'_IMP_after_loop_def
...
lemma dsqrt'_IMP_correct_function_1:
  "(invoke_subprogram p dsqrt'_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  apply (simp only: dsqrt'_IMP_def prefix_simps)
  apply(vcg dsqrt'_IMP_vars)

  subgoal by (fastforce simp add: dsqrt'_imp_to_HOL_state_def dsqrt'_IMP_subprogram_simps)

  subgoal
    apply (simp only: dsqrt'_IMP_while_condition_def prefix_simps)
    by (auto simp add: dsqrt'_imp_to_HOL_state_def)


  subgoal
    apply(subst (asm) (1) dsqrt'_IMP_while_condition_def)
    apply(subst (asm) (1) dsqrt'_IMP_loop_body_def)
...
lemma dsqrt'_IMP_correct_effects:
  "(invoke_subprogram (p @ dsqrt'_prefix) dsqrt'_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  v \<in> vars \<Longrightarrow> \<not> (prefix dsqrt'_prefix v) \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars
  by (metis prefix_def)

lemma dsqrt'_IMP_correct[functional_correctness]:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) dsqrt'_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (prefix p2 v);
     \<lbrakk>t = (dsqrt'_imp_time 0 (dsqrt'_imp_to_HOL_state (p1 @ p2) s));
      ...
      \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
     \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using dsqrt'_IMP_correct_time dsqrt'_IMP_correct_function_1
    dsqrt'_IMP_correct_effects
  by auto
...
definition dsqrt_IMP where
  ...
  (
    ...
    invoke_subprogram dsqrt'_pref dsqrt'_IMP;;
...
lemma dsqrt_IMP_correct_function:
  "(invoke_subprogram p dsqrt_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p dsqrt_ret_str) = dsqrt_state_ret (dsqrt_imp (dsqrt_imp_to_HOL_state p s))"
  apply(subst dsqrt_imp.simps)
  apply(simp only: dsqrt_IMP_def prefix_simps)
...
lemma dsqrt_IMP_correct_effects:
  "(invoke_subprogram (p @ dsqrt_pref) dsqrt_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  v \<in> vars \<Longrightarrow> \<not> (prefix dsqrt_pref v) \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma dsqrt_IMP_correct[let_function_correctness]:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) dsqrt_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (prefix p2 v);
     \<lbrakk>t = (dsqrt_imp_time 0 (dsqrt_imp_to_HOL_state (p1 @ p2) s));
      ...
      \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
     \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using dsqrt_IMP_correct_time dsqrt_IMP_correct_function
    dsqrt_IMP_correct_effects
  by auto
...
lemma triangle_IMP_correct_function:
  "(invoke_subprogram p triangle_IMP, s)
      \<Rightarrow>\<^bsup>t \<^esup> s'
    \<Longrightarrow> s' (add_prefix p triangle_triangle_str) =
          triangle_triangle (triangle_imp (triangle_imp_to_HOL_state p s))"
  by (fastforce elim: mul_IMP_correct simp: triangle_IMP_def triangle_imp.simps
      invoke_subprogram_append mul_imp_to_HOL_state_def triangle_state_upd_def
      triangle_imp_to_HOL_state_def)

lemma triangle_IMP_correct_time:
  "(invoke_subprogram p triangle_IMP, s)
      \<Rightarrow>\<^bsup>t\<^esup> s'
    \<Longrightarrow> t = triangle_imp_time 0 (triangle_imp_to_HOL_state p s)"
  by (fastforce elim: mul_IMP_correct simp: triangle_IMP_def invoke_subprogram_append
      triangle_imp_to_HOL_state_def mul_imp_to_HOL_state_def triangle_imp_time.simps)

lemma triangle_IMP_correct_effects:
  "(invoke_subprogram (p @ triangle_pref) triangle_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  v \<in> vars \<Longrightarrow> \<not> (prefix triangle_pref v) \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma triangle_IMP_correct[functional_correctness]:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) triangle_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (prefix p2 v);
    \<lbrakk>t = (triangle_imp_time 0 (triangle_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
     \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using triangle_IMP_correct_time triangle_IMP_correct_function
    triangle_IMP_correct_effects
  by auto
...
definition tsqrt_IMP where
  ...
  (
    ...
    invoke_subprogram dsqrt_prefix dsqrt_IMP;;
...
lemma tsqrt_IMP_correct_function:
  "(invoke_subprogram p tsqrt_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p tsqrt_ret_str) = tsqrt_state_ret (tsqrt_imp (tsqrt_imp_to_HOL_state p s))"
  by (fastforce elim: mul_IMP_correct dsqrt_IMP_correct simp: tsqrt_imp.simps
      tsqrt_imp_state_upd_def tsqrt_imp_to_HOL_state_def dsqrt_imp_to_HOL_state_def
      mul_imp_to_HOL_state_def Let_def tsqrt_IMP_def invoke_subprogram_append)

lemma tsqrt_IMP_correct_time:
  "(invoke_subprogram p tsqrt_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     t = tsqrt_imp_time 0 (tsqrt_imp_to_HOL_state p s)"
  by (fastforce elim: mul_IMP_correct dsqrt_IMP_correct simp: tsqrt_imp_time.simps
      tsqrt_imp_state_upd_def tsqrt_imp_to_HOL_state_def dsqrt_imp_to_HOL_state_def
      mul_imp_to_HOL_state_def Let_def tsqrt_IMP_def invoke_subprogram_append)

lemma tsqrt_IMP_correct_effects:
  "(invoke_subprogram (p @ tsqrt_pref) tsqrt_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>  v \<in> vars
  \<Longrightarrow> \<not> (prefix tsqrt_pref v) \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma tsqrt_IMP_correct[functional_correctness]:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) tsqrt_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (prefix p2 v);
     \<lbrakk>t = (tsqrt_imp_time 0 (tsqrt_imp_to_HOL_state (p1 @ p2) s));
      ...
      \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
     \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using tsqrt_IMP_correct_time tsqrt_IMP_correct_function
    tsqrt_IMP_correct_effects
  by auto
...
lemma fst'_IMP_correct_function:
  "(invoke_subprogram p fst'_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p fst'_p_str) = fst'_state_p (fst'_imp (fst'_imp_to_HOL_state p s))"
  apply(subst fst'_imp.simps)
  apply(simp only: fst'_IMP_def prefix_simps)
...
lemma fst'_IMP_correct_effects:
  "(invoke_subprogram (p @ fst'_pref) fst'_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>  v \<in> vars
  \<Longrightarrow> \<not> (prefix fst'_pref v) \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma fst'_IMP_correct[functional_correctness]:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) fst'_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (prefix p2 v);
     \<lbrakk>t = (fst'_imp_time 0 (fst'_imp_to_HOL_state (p1 @ p2) s));
      ...
      \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
     \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using fst'_IMP_correct_time fst'_IMP_correct_function
    fst'_IMP_correct_effects
  by auto
...
lemma snd'_IMP_correct_function:
  "(invoke_subprogram p snd'_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p snd'_p_str) = snd'_state_p (snd'_imp (snd'_imp_to_HOL_state p s))"
  apply(subst snd'_imp.simps)
  apply(simp only: snd'_IMP_def prefix_simps)
...
lemma snd'_IMP_correct_effects:
  "(invoke_subprogram (p @ snd'_pref) snd'_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>  v \<in> vars
  \<Longrightarrow> \<not> (prefix snd'_pref v) \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma snd'_IMP_correct[functional_correctness]:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) snd'_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (prefix p2 v);
     \<lbrakk>t = (snd'_imp_time 0 (snd'_imp_to_HOL_state (p1 @ p2) s));
      ...
      \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
     \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using snd'_IMP_correct_time snd'_IMP_correct_function
    snd'_IMP_correct_effects
  by auto
...
definition prod_decode_IMP where
  "prod_decode_IMP \<equiv>
  (
...
lemma prod_decode_IMP_correct_function_1:
  "(invoke_subprogram p prod_decode_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma prod_decode_IMP_correct_time:
  "(invoke_subprogram p prod_decode_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     t = prod_decode_imp_time 0 (prod_decode_imp_to_HOL_state p s)"
  by (fastforce
      elim: fst'_IMP_correct[where vars = "prod_decode_IMP_vars"] snd'_IMP_correct
      simp:  prod_decode_imp_to_HOL_state_def invoke_subprogram_append fst'_imp_to_HOL_state_def
      snd'_imp_to_HOL_state_def prod_decode_IMP_def prod_decode_imp_time.simps)

lemma prod_decode_IMP_correct_effects:
  "(invoke_subprogram (p @ prod_decode_pref) prod_decode_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>  v \<in> vars
  \<Longrightarrow> \<not> (prefix prod_decode_pref v) \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma prod_decode_IMP_correct[functional_correctness]:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) prod_decode_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (prefix p2 v);
     \<lbrakk>t = (prod_decode_imp_time 0 (prod_decode_imp_to_HOL_state (p1 @ p2) s));
      ...
      \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
     \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using prod_decode_IMP_correct_time
    prod_decode_IMP_correct_function_1 prod_decode_IMP_correct_function_2
    prod_decode_IMP_correct_effects
  by auto
...
definition prod_encode_IMP where "prod_encode_IMP \<equiv>
...
lemma prod_encode_IMP_correct_function:
  "(invoke_subprogram p prod_encode_IMP, s)
      \<Rightarrow>\<^bsup>t \<^esup> s'
    \<Longrightarrow> s' (add_prefix p prod_encode_ret_str) = prod_encode_ret (prod_encode_imp (prod_encode_imp_to_HOL_state p s))"
  by (fastforce elim: triangle_IMP_correct[where vars = "{prod_encode_a_str}"]
      simp: prod_encode_state_upd_def prod_encode_imp_to_HOL_state_def triangle_imp_to_HOL_state_def
      prod_encode_IMP_def prod_encode_imp.simps invoke_subprogram_append)

lemma prod_encode_IMP_correct_time:
  "(invoke_subprogram p prod_encode_IMP, s)
      \<Rightarrow>\<^bsup>t\<^esup> s'
    \<Longrightarrow> t = prod_encode_imp_time 0 (prod_encode_imp_to_HOL_state p s)"
  by (fastforce elim: triangle_IMP_correct[where vars = "{prod_encode_a_str}"]
      simp: prod_encode_state_upd_def prod_encode_imp_to_HOL_state_def triangle_imp_to_HOL_state_def
      prod_encode_IMP_def prod_encode_imp_time.simps invoke_subprogram_append)

lemma prod_encode_IMP_correct_effects:
  "(invoke_subprogram (p @ prod_encode_pref) prod_encode_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow> v \<in> vars
  \<Longrightarrow> \<not> (prefix prod_encode_pref v) \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma prod_encode_IMP_correct[functional_correctness]:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) prod_encode_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (prefix p2 v);
     \<lbrakk>t = (prod_encode_imp_time 0 (prod_encode_imp_to_HOL_state (p1 @ p2) s));
      ...
      \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
     \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using prod_encode_IMP_correct_time prod_encode_IMP_correct_function
    prod_encode_IMP_correct_effects
  by fastforce
...
definition AND_neq_zero_IMP where
  "AND_neq_zero_IMP \<equiv>
  (
...
lemma AND_neq_zero_IMP_correct_function:
  "(invoke_subprogram p AND_neq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  apply(simp only: AND_neq_zero_IMP_def com_add_prefix.simps aexp_add_prefix.simps atomExp_add_prefix.simps invoke_subprogram_append)
  apply(erule If_tE)
   apply(erule If_tE)
    apply(drule AssignD)+
    apply(elim conjE)
...
lemma AND_neq_zero_IMP_correct_time:
  "(invoke_subprogram p AND_neq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma AND_neq_zero_IMP_correct_effects:
  "(invoke_subprogram (p @ AND_neq_zero_pref) AND_neq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  v \<in> vars \<Longrightarrow> \<not> (prefix AND_neq_zero_pref v) \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma AND_neq_zero_IMP_correct[functional_correctness]:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) AND_neq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (prefix p2 v);
     \<lbrakk>t = (AND_neq_zero_imp_time 0 (AND_neq_zero_imp_to_HOL_state (p1 @ p2) s));
      ...
      \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
     \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using AND_neq_zero_IMP_correct_time AND_neq_zero_IMP_correct_function
    AND_neq_zero_IMP_correct_effects
  by auto
...
definition OR_neq_zero_IMP where
  "OR_neq_zero_IMP \<equiv>
  (
...
lemma OR_neq_zero_IMP_correct_function:
  "(invoke_subprogram p OR_neq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  apply(simp only: OR_neq_zero_IMP_def com_add_prefix.simps aexp_add_prefix.simps atomExp_add_prefix.simps invoke_subprogram_append)
  apply(erule If_tE)
   apply(drule AssignD)+
   apply(elim conjE)
...
lemma OR_neq_zero_IMP_correct_time:
  "(invoke_subprogram p OR_neq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma OR_neq_zero_IMP_correct_effects:
  "(invoke_subprogram (p @ OR_neq_zero_pref) OR_neq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  v \<in> vars \<Longrightarrow> \<not> (prefix OR_neq_zero_pref v) \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma OR_neq_zero_IMP_correct[functional_correctness]:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) OR_neq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (prefix p2 v);
     \<lbrakk>t = (OR_neq_zero_imp_time 0 (OR_neq_zero_imp_to_HOL_state (p1 @ p2) s));
      ...
      \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
     \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using OR_neq_zero_IMP_correct_time OR_neq_zero_IMP_correct_function
    OR_neq_zero_IMP_correct_effects
  by auto
...
definition "EQUAL_neq_zero_IMP \<equiv>
...
lemma EQUAL_neq_zero_IMP_correct_function:
  "(invoke_subprogram p EQUAL_neq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p EQUAL_neq_zero_ret_str)
      = EQUAL_neq_zero_ret (EQUAL_neq_zero_imp (EQUAL_neq_zero_imp_to_HOL_state p s))"
  by (force simp: EQUAL_neq_zero_imp.simps EQUAL_neq_zero_IMP_def
      EQUAL_neq_zero_imp_to_HOL_state_def EQUAL_neq_zero_state_upd_def)

lemma EQUAL_neq_zero_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ EQUAL_neq_zero_pref) EQUAL_neq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    v \<in> vars; \<not> (prefix EQUAL_neq_zero_pref v)\<rbrakk>
  \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma EQUAL_neq_zero_IMP_correct_time:
  "(invoke_subprogram p EQUAL_neq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     t = EQUAL_neq_zero_imp_time 0 (EQUAL_neq_zero_imp_to_HOL_state p s)"
  by(force simp: EQUAL_neq_zero_imp_time.simps EQUAL_neq_zero_IMP_def
      EQUAL_neq_zero_imp_to_HOL_state_def EQUAL_neq_zero_state_upd_def)

lemma EQUAL_neq_zero_IMP_correct[functional_correctness]:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) EQUAL_neq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (prefix p2 v);
     \<lbrakk>t = (EQUAL_neq_zero_imp_time 0 (EQUAL_neq_zero_imp_to_HOL_state (p1 @ p2) s));
      ...
      \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
     \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using EQUAL_neq_zero_IMP_correct_function
  by (auto simp: EQUAL_neq_zero_IMP_correct_time)
    (meson EQUAL_neq_zero_IMP_correct_effects set_mono_prefix)
...
definition "NOTEQUAL_neq_zero_IMP \<equiv>
...
lemma NOTEQUAL_neq_zero_IMP_correct_function:
  "(invoke_subprogram p NOTEQUAL_neq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  by (force simp: NOTEQUAL_neq_zero_imp.simps NOTEQUAL_neq_zero_IMP_def
      NOTEQUAL_neq_zero_imp_to_HOL_state_def NOTEQUAL_neq_zero_state_upd_def)

lemma NOTEQUAL_neq_zero_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ NOTEQUAL_neq_zero_pref) NOTEQUAL_neq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    v \<in> vars; \<not> (prefix NOTEQUAL_neq_zero_pref v)\<rbrakk>
  \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma NOTEQUAL_neq_zero_IMP_correct_time:
  "(invoke_subprogram p NOTEQUAL_neq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     t = NOTEQUAL_neq_zero_imp_time 0 (NOTEQUAL_neq_zero_imp_to_HOL_state p s)"
  by(force simp: NOTEQUAL_neq_zero_imp_time.simps NOTEQUAL_neq_zero_IMP_def
      NOTEQUAL_neq_zero_imp_to_HOL_state_def NOTEQUAL_neq_zero_state_upd_def)

lemma NOTEQUAL_neq_zero_IMP_correct[functional_correctness]:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) NOTEQUAL_neq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (prefix p2 v);
  ...
  \<Longrightarrow> P"
  using NOTEQUAL_neq_zero_IMP_correct_function
  by (auto simp: NOTEQUAL_neq_zero_IMP_correct_time)
    (meson NOTEQUAL_neq_zero_IMP_correct_effects set_mono_prefix)
...
definition "NOTEQUAL_neq_one_IMP \<equiv>
...
lemma NOTEQUAL_neq_one_IMP_correct_function:
  "(invoke_subprogram p NOTEQUAL_neq_one_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p NOTEQUAL_neq_one_ret_str)
      = NOTEQUAL_neq_one_ret (NOTEQUAL_neq_one_imp (NOTEQUAL_neq_one_imp_to_HOL_state p s))"
  by (force simp: NOTEQUAL_neq_one_imp.simps NOTEQUAL_neq_one_IMP_def
      NOTEQUAL_neq_one_imp_to_HOL_state_def NOTEQUAL_neq_one_state_upd_def)

lemma NOTEQUAL_neq_one_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ NOTEQUAL_neq_one_pref) NOTEQUAL_neq_one_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    v \<in> vars; \<not> (prefix NOTEQUAL_neq_one_pref v)\<rbrakk>
  \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma NOTEQUAL_neq_one_IMP_correct_time:
  "(invoke_subprogram p NOTEQUAL_neq_one_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     t = NOTEQUAL_neq_one_imp_time 0 (NOTEQUAL_neq_one_imp_to_HOL_state p s)"
  by(force simp: NOTEQUAL_neq_one_imp_time.simps NOTEQUAL_neq_one_IMP_def
      NOTEQUAL_neq_one_imp_to_HOL_state_def NOTEQUAL_neq_one_state_upd_def)

lemma NOTEQUAL_neq_one_IMP_correct[functional_correctness]:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) NOTEQUAL_neq_one_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (prefix p2 v);
    \<lbrakk>t = (NOTEQUAL_neq_one_imp_time 0 (NOTEQUAL_neq_one_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk> \<Longrightarrow> P\<rbrakk>
  \<Longrightarrow> P"
  using NOTEQUAL_neq_one_IMP_correct_function
  by (auto simp: NOTEQUAL_neq_one_IMP_correct_time)
    (meson NOTEQUAL_neq_one_IMP_correct_effects set_mono_prefix)
...
definition LESS_neq_zero_IMP where
  "LESS_neq_zero_IMP \<equiv>
...
lemma LESS_neq_zero_IMP_correct_function:
  "(invoke_subprogram p LESS_neq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p LESS_neq_zero_ret_str)
      = LESS_neq_zero_ret
          (LESS_neq_zero_imp (LESS_neq_zero_imp_to_HOL_state p s))"
  by (force simp: LESS_neq_zero_imp.simps LESS_neq_zero_IMP_def
      LESS_neq_zero_imp_to_HOL_state_def LESS_neq_zero_state_upd_def)

lemma LESS_neq_zero_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ LESS_neq_zero_pref) LESS_neq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    v \<in> vars; \<not> (prefix LESS_neq_zero_pref v)\<rbrakk>
   \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma LESS_neq_zero_IMP_correct_time:
  "(invoke_subprogram p LESS_neq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     t = LESS_neq_zero_imp_time 0 (LESS_neq_zero_imp_to_HOL_state p s)"
  by(force simp: LESS_neq_zero_imp_time.simps LESS_neq_zero_IMP_def)

lemma LESS_neq_zero_IMP_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) LESS_neq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (LESS_neq_zero_imp_time 0 (LESS_neq_zero_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using LESS_neq_zero_IMP_correct_function
    LESS_neq_zero_IMP_correct_time
    LESS_neq_zero_IMP_correct_effects
...
definition LESS_EQUAL_neq_zero_IMP where
  "LESS_EQUAL_neq_zero_IMP \<equiv>
...
lemma LESS_EQUAL_neq_zero_IMP_correct_function:
  "(invoke_subprogram p LESS_EQUAL_neq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  by (force simp: LESS_EQUAL_neq_zero_imp.simps LESS_EQUAL_neq_zero_IMP_def
    LESS_EQUAL_neq_zero_imp_to_HOL_state_def LESS_EQUAL_neq_zero_state_upd_def)

lemma LESS_EQUAL_neq_zero_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ LESS_EQUAL_neq_zero_pref) LESS_EQUAL_neq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    v \<in> vars; \<not> (prefix LESS_EQUAL_neq_zero_pref v)\<rbrakk>
   \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma LESS_EQUAL_neq_zero_IMP_correct_time:
  "(invoke_subprogram p LESS_EQUAL_neq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     t = LESS_EQUAL_neq_zero_imp_time 0 (LESS_EQUAL_neq_zero_imp_to_HOL_state p s)"
  by(force simp: LESS_EQUAL_neq_zero_imp_time.simps LESS_EQUAL_neq_zero_IMP_def)

lemma LESS_EQUAL_neq_zero_IMP_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) LESS_EQUAL_neq_zero_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (LESS_EQUAL_neq_zero_imp_time 0 (LESS_EQUAL_neq_zero_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using LESS_EQUAL_neq_zero_IMP_correct_function
    LESS_EQUAL_neq_zero_IMP_correct_time
    LESS_EQUAL_neq_zero_IMP_correct_effects
  by (meson set_mono_prefix)
...
lemma some_nat_IMP_correct_function:
  "(invoke_subprogram p some_nat_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p some_nat_ret_str)
      = some_nat_ret
          (some_nat_imp (some_nat_imp_to_HOL_state p s))"
  apply(simp only: some_nat_IMP_def prefix_simps)
  apply(erule Seq_E)+
  by (fastforce simp: some_nat_state_translators some_nat_imp.simps
      some_nat_state_upd_def)

lemma some_nat_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ some_nat_pref) some_nat_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    v \<in> vars; \<not> (prefix some_nat_pref v)\<rbrakk>
   \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma some_nat_IMP_correct_time:
  "(invoke_subprogram p some_nat_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma some_nat_IMP_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) some_nat_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (some_nat_imp_time 0 (some_nat_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using some_nat_IMP_correct_function some_nat_IMP_correct_time
  by (meson some_nat_IMP_correct_effects set_mono_prefix)
...
definition hd_IMP where
  ...
  (     \<comment> \<open>prod_decode_m' = hd_xs s - 1;\<close>
        ...
        invoke_subprogram prod_decode_prefix prod_decode_IMP;;
...
lemma hd_IMP_correct_effects:
  "(invoke_subprogram (p @ hd_pref) hd_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow> v \<in> vars \<Longrightarrow> \<not> (prefix hd_pref v) \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma hd_IMP_correct[functional_correctness]:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) hd_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (prefix p2 v);
     \<lbrakk>t = (hd_imp_time 0 (hd_imp_to_HOL_state (p1 @ p2) s));
      ...
      \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
     \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using hd_IMP_correct_time hd_IMP_correct_function
    hd_IMP_correct_effects
  by auto
...
lemma tl_IMP_correct_effects:
  "(invoke_subprogram (p @ tl_pref) tl_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow> v \<in> vars \<Longrightarrow> \<not> (prefix tl_pref v) \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma tl_IMP_correct[functional_correctness]:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) tl_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (prefix p2 v);
     \<lbrakk>t = (tl_imp_time 0 (tl_imp_to_HOL_state (p1 @ p2) s));
      ...
      \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
     \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using tl_IMP_correct_time tl_IMP_correct_function
    tl_IMP_correct_effects
  by auto
...
definition "map_list_find_aux_IMP_init_while_cond \<equiv>
  ...
  invoke_subprogram NOTEQUAL_neq_zero_prefix NOTEQUAL_neq_zero_IMP;;
  \<comment> \<open>\<close>
...
definition map_list_find_aux_IMP where
  "map_list_find_aux_IMP \<equiv>
...
lemma map_list_find_aux_IMP_correct_function:
  "(invoke_subprogram p map_list_find_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  apply(subst map_list_find_aux_imp.simps)
  apply(simp only: map_list_find_aux_IMP_def prefix_simps)
  apply(erule Seq_E)+
  apply(erule While_tE)
  ...
  subgoal
    ...
    apply(erule Seq_E)+
    apply(erule hd_IMP_correct[where vars = "map_list_find_aux_IMP_vars"])
    subgoal premises p using p(20) by fastforce
    apply(erule fst'_IMP_correct[where vars = "map_list_find_aux_IMP_vars"])
    subgoal premises p using p(22) by fastforce
    apply(erule NOTEQUAL_neq_zero_IMP_correct[where vars = "map_list_find_aux_IMP_vars"])
    subgoal premises p using p(24) by fastforce
    apply(erule AND_neq_zero_IMP_correct[where vars = "map_list_find_aux_IMP_vars"])
    ...
    apply (erule If_E)
      subgoal
        ...
        apply(erule snd'_IMP_correct[where vars = "map_list_find_aux_IMP_vars"])
        subgoal premises p using p(39) by fastforce
        apply(erule some_nat_IMP_correct[where vars = "map_list_find_aux_IMP_vars"])
  ...
  subgoal
      ...
      apply(erule tl_IMP_correct[where vars = "map_list_find_aux_IMP_vars"])
...
lemma map_list_find_aux_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ map_list_find_aux_pref) map_list_find_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
...
lemma map_list_find_aux_IMP_correct_time:
  "(invoke_subprogram p map_list_find_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma map_list_find_aux_IMP_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) map_list_find_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (map_list_find_aux_imp_time 0 (map_list_find_aux_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using map_list_find_aux_IMP_correct_function
  by (auto simp: map_list_find_aux_IMP_correct_time)
    (meson map_list_find_aux_IMP_correct_effects set_mono_prefix)
...
lemma length_IMP_correct_function:
  "(invoke_subprogram p length_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  apply(subst length_imp.simps)
  apply(simp only: length_IMP_def prefix_simps)
  apply(erule While_tE)
   apply(subst length_imp.simps)
   apply(auto simp: length_imp_time_acc length_imp_to_HOL_state_def)[1]
  apply(dest_com')
  apply(erule Seq_tE)+
  apply(erule tl_IMP_correct[where vars = "{length_ret_str}"])
   apply auto [1]
  apply(drule AssignD)+
  apply(elim conjE)
...
lemma length_IMP_correct_time:
  "(invoke_subprogram p length_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     t = length_imp_time 0 (length_imp_to_HOL_state p s)"
  apply(induction "length_imp_to_HOL_state p s" arbitrary: s s' t rule: length_imp.induct)
  apply(subst length_imp_time.simps)
  apply(simp only: length_IMP_def com_add_prefix.simps aexp_add_prefix.simps
...
lemma length_IMP_correct_effects:
  "(invoke_subprogram (p @ p2) length_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow> v \<in> vars \<Longrightarrow>
  \<not> (prefix p2 v) \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma length_IMP_correct[functional_correctness]:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) length_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (prefix p2 v);
     \<lbrakk>t = (length_imp_time 0 (length_imp_to_HOL_state (p1 @ p2) s));
      ...
      \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
     \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using length_IMP_correct_time length_IMP_correct_function
    length_IMP_correct_effects
  by auto
...
lemma length'_IMP_correct_function:
  "(invoke_subprogram p length'_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  apply(simp only: length'_IMP_def prefix_simps)
   apply(subst length_imp.simps)
   apply(auto simp: length'_imp_time_acc length'_imp_to_HOL_state_def)
  apply(erule length_IMP_correct[where vars = "{length'_ret_str}"])
  subgoal by auto
...
lemma length'_IMP_correct_time:
  "(invoke_subprogram p length'_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     t = length'_imp_time 0 (length'_imp_to_HOL_state p s)"
  apply(induction "length'_imp_to_HOL_state p s" arbitrary: s s' t rule: length'_imp.induct)
  apply(subst length'_imp_time.simps)
  apply(simp only: length'_IMP_def com_add_prefix.simps aexp_add_prefix.simps
      atomExp_add_prefix.simps invoke_subprogram_append)
   apply(auto simp: length'_imp_to_HOL_state_def)[1]
  apply(erule length_IMP_correct[where vars = "{length'_ret_str}"])
   apply auto [1]
...
lemma length'_IMP_correct_effects:
  "(invoke_subprogram (p @ p2) length'_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow> v \<in> vars \<Longrightarrow>
  \<not> (prefix p2 v) \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma length'_IMP_correct[functional_correctness]:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) length'_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (prefix p2 v);
     \<lbrakk>t = (length'_imp_time 0 (length'_imp_to_HOL_state (p1 @ p2) s));
      ...
      \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
     \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using length'_IMP_correct_time length'_IMP_correct_function
    length'_IMP_correct_effects
  by auto
...
lemma cons_IMP_correct_function:
  "(invoke_subprogram p cons_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p cons_ret_str) = cons_ret (cons_imp (cons_imp_to_HOL_state p s))"
  by(fastforce elim: prod_encode_IMP_correct simp add: cons_IMP_def cons_imp.simps
      invoke_subprogram_append cons_state_upd_def cons_imp_to_HOL_state_def
      prod_encode_imp_to_HOL_state_def)

lemma cons_IMP_correct_time:
  "(invoke_subprogram p cons_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     t = cons_imp_time 0 (cons_imp_to_HOL_state p s)"
  by(fastforce elim: prod_encode_IMP_correct simp add: cons_IMP_def cons_imp_time.simps
      invoke_subprogram_append cons_state_upd_def cons_imp_to_HOL_state_def
      prod_encode_imp_to_HOL_state_def)

lemma cons_IMP_correct_effects:
  "(invoke_subprogram (p @ cons_pref) cons_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow> v \<in> vars
  \<Longrightarrow> \<not> (prefix cons_pref v) \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma cons_IMP_correct[functional_correctness]:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) cons_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (prefix p2 v);
     \<lbrakk>t = (cons_imp_time 0 (cons_imp_to_HOL_state (p1 @ p2) s));
      ...
      \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
     \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using cons_IMP_correct_time cons_IMP_correct_function
    cons_IMP_correct_effects
  by auto
...
definition reverse_nat_acc_IMP where
  "reverse_nat_acc_IMP \<equiv>
...
lemma reverse_nat_acc_IMP_correct_function:
  "(invoke_subprogram p reverse_nat_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  apply(simp only: reverse_nat_acc_IMP_def prefix_simps)
...
lemma reverse_nat_acc_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ reverse_nat_acc_pref) reverse_nat_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    v \<in> vars; \<not> (prefix reverse_nat_acc_pref v)\<rbrakk>
  \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma reverse_nat_acc_IMP_correct_time_loop_condition:
...
lemma reverse_nat_acc_IMP_correct_time:
  "(invoke_subprogram p reverse_nat_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma reverse_nat_acc_IMP_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) reverse_nat_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (prefix p2 v);
     \<lbrakk>t = (reverse_nat_acc_imp_time 0 (reverse_nat_acc_imp_to_HOL_state (p1 @ p2) s));
      ...
      \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
     \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using reverse_nat_acc_IMP_correct_function
  by (auto simp: reverse_nat_acc_IMP_correct_time)
    (meson reverse_nat_acc_IMP_correct_effects set_mono_prefix)
...
definition reverse_nat_IMP where
  "reverse_nat_IMP \<equiv>
  ...
  invoke_subprogram reverse_nat_acc_prefix reverse_nat_acc_IMP;;
...
lemma reverse_nat_IMP_correct_function:
  "(invoke_subprogram p reverse_nat_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p reverse_nat_ret_str)
      = reverse_nat_ret (reverse_nat_imp (reverse_nat_imp_to_HOL_state p s))"
  by (fastforce elim: reverse_nat_acc_IMP_correct simp: reverse_nat_imp_to_HOL_state_def
      reverse_nat_imp.simps reverse_nat_state_upd_def reverse_nat_acc_imp_to_HOL_state_def
      reverse_nat_IMP_def invoke_subprogram_append)

lemma reverse_nat_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ reverse_nat_pref) reverse_nat_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    v \<in> vars; \<not> (prefix reverse_nat_pref v)\<rbrakk>
  \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma reverse_nat_IMP_correct_time:
  "(invoke_subprogram p reverse_nat_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     t = reverse_nat_imp_time 0 (reverse_nat_imp_to_HOL_state p s)"
  by (fastforce elim: reverse_nat_acc_IMP_correct simp: reverse_nat_imp_to_HOL_state_def
      reverse_nat_imp_time.simps reverse_nat_acc_imp_to_HOL_state_def reverse_nat_IMP_def
      invoke_subprogram_append)

lemma reverse_nat_IMP_correct[functional_correctness]:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) reverse_nat_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (prefix p2 v);
     \<lbrakk>t = (reverse_nat_imp_time 0 (reverse_nat_imp_to_HOL_state (p1 @ p2) s));
      ...
      \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
     \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using reverse_nat_IMP_correct_time reverse_nat_IMP_correct_function
    reverse_nat_IMP_correct_effects
  by (meson set_mono_prefix)
...
abbreviation "append_IMP_1 \<equiv>
...
lemma append_IMP_correct_function:
  "(invoke_subprogram p append_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  apply(simp only: append_IMP_def prefix_simps)
  apply(erule While_tE, fastforce simp: append_imp_time_acc append_imp_to_HOL_state_def)
  apply(dest_com')
  apply(erule Seq_tE)+
  apply(erule tl_IMP_correct[where vars = append_IMP_vars], fastforce)
  apply(erule hd_IMP_correct[where vars = append_IMP_vars], fastforce)
  apply(erule cons_IMP_correct[where vars = append_IMP_vars], fastforce)
...
lemma append_IMP_correct_time:
  "(invoke_subprogram p append_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     t = append_imp_time 0 (append_imp_to_HOL_state p s)"
  apply(induction "append_imp_to_HOL_state p s" arbitrary: s s' t rule: append_imp.induct)
  apply(subst append_imp_time.simps)
  apply(simp only: append_IMP_def com_add_prefix.simps aexp_add_prefix.simps
      atomExp_add_prefix.simps invoke_subprogram_append)
  apply(erule While_tE, fastforce simp: append_imp_time_acc append_imp_to_HOL_state_def)
  apply(dest_com')
  apply(erule Seq_tE)+
...
lemma append_IMP_correct_effects:
  "(invoke_subprogram (p @ append_pref) append_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow> v \<in> vars \<Longrightarrow>
  \<not> (prefix append_pref v) \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma append_IMP_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) append_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (prefix p2 v);
     \<lbrakk>t = (append_imp_time 0 (append_imp_to_HOL_state (p1 @ p2) s));
      ...
      \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
     \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using append_IMP_correct_time append_IMP_correct_function
    append_IMP_correct_effects
  by auto
...
definition append_nat_IMP where
  "append_nat_IMP \<equiv>
  ...
  invoke_subprogram append_prefix append_IMP;;
...
lemma append_nat_IMP_correct_function:
  "(invoke_subprogram p append_nat_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p append_nat_ret_str)
      = append_nat_ret (append_nat_imp (append_nat_imp_to_HOL_state p s))"
  apply (simp add: append_nat_IMP_def invoke_subprogram_append)
  apply(vcg append_nat_IMP_vars functional_correctness: append_IMP_correct)
...
lemma append_nat_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ append_nat_pref) append_nat_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    v \<in> vars; \<not> (prefix append_nat_pref v)\<rbrakk>
  \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma append_nat_IMP_correct_time:
  "(invoke_subprogram p append_nat_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     t = append_nat_imp_time 0 (append_nat_imp_to_HOL_state p s)"
  apply (simp add: append_nat_IMP_def invoke_subprogram_append)
  apply(vcg_time append_nat_IMP_vars functional_correctness: append_IMP_correct)
...
lemma append_nat_IMP_correct[functional_correctness]:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) append_nat_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (prefix p2 v);
     \<lbrakk>t = (append_nat_imp_time 0 (append_nat_imp_to_HOL_state (p1 @ p2) s));
      ...
      \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
     \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using append_nat_IMP_correct_time append_nat_IMP_correct_function
    append_nat_IMP_correct_effects
  by (meson set_mono_prefix)
...
definition list_from_acc_IMP where
  "list_from_acc_IMP \<equiv>
...
lemma list_from_acc_IMP_correct_function:
  "(invoke_subprogram p list_from_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  apply(simp only: list_from_acc_IMP_def prefix_simps)
  apply(erule Seq_E)+
  apply(erule While_tE)
  ...
  subgoal
      ...
      apply(erule Seq_E)+
      apply(erule cons_IMP_correct[where vars = "list_from_acc_IMP_vars"])
...
lemma list_from_acc_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ list_from_acc_pref) list_from_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
...
lemma list_from_acc_IMP_correct_time:
  "(invoke_subprogram p list_from_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  subgoal
    ...
    list_from_acc_complete_time_simps Let_def cons_imp_correct
             list_from_acc_state.simps cons_state.simps cons_IMP_correct_time)
    by(clarsimp)
...
lemma list_from_acc_IMP_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) list_from_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (list_from_acc_imp_time 0 (list_from_acc_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using list_from_acc_IMP_correct_function list_from_acc_IMP_correct_effects
    list_from_acc_IMP_correct_time
  by (meson set_mono_prefix)
...
definition list_from_tail_IMP where
  "list_from_tail_IMP \<equiv>
  ...
  invoke_subprogram list_from_acc_prefix list_from_acc_IMP;;
...
lemma list_from_tail_IMP_correct_function:
  "(invoke_subprogram p list_from_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p list_from_tail_ret_str)
      = list_from_tail_ret
          (list_from_tail_imp (list_from_tail_imp_to_HOL_state p s))"
  by (fastforce elim: list_from_acc_IMP_correct reverse_nat_IMP_correct
      simp: list_from_tail_imp_to_HOL_state_def
      list_from_tail_imp.simps list_from_tail_state_upd_def
      reverse_nat_imp_to_HOL_state_def
      list_from_acc_imp_to_HOL_state_def
      list_from_tail_IMP_def invoke_subprogram_append)

lemma list_from_tail_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ list_from_tail_pref) list_from_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    v \<in> vars; \<not> (prefix list_from_tail_pref v)\<rbrakk>
   \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma list_from_tail_IMP_correct_time:
  "(invoke_subprogram p list_from_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     t = list_from_tail_imp_time 0 (list_from_tail_imp_to_HOL_state p s)"
  apply(simp only: list_from_tail_IMP_def prefix_simps)
  apply(erule Seq_tE)+
  apply(erule list_from_acc_IMP_correct[where vars=list_from_tail_IMP_vars])
  subgoal premises p using p(21) by fastforce
  apply(erule reverse_nat_IMP_correct[where vars=list_from_tail_IMP_vars])
  subgoal premises p using p(23) by fastforce
  by (fastforce simp: Let_def list_from_tail_state_translators
      list_from_tail_imp_time.simps list_from_tail_state_upd_def)

lemma list_from_tail_IMP_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) list_from_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (list_from_tail_imp_time 0 (list_from_tail_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using list_from_tail_IMP_correct_function list_from_tail_IMP_correct_time
  by (meson list_from_tail_IMP_correct_effects set_mono_prefix)
...
definition list_less_tail_IMP where
  "list_less_tail_IMP \<equiv>
  ...
  invoke_subprogram list_from_tail_prefix list_from_tail_IMP;;
...
lemma list_less_tail_IMP_correct_function:
  "(invoke_subprogram p list_less_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p list_less_tail_ret_str)
      = list_less_tail_ret
          (list_less_tail_imp (list_less_tail_imp_to_HOL_state p s))"
  apply(simp only: list_less_tail_IMP_def prefix_simps)
  apply(erule Seq_E)+
  apply(erule list_from_tail_IMP_correct[where vars=list_less_tail_IMP_vars])
  subgoal premises p using p(6) by fastforce
  by (fastforce simp: list_less_tail_state_translators list_less_tail_imp.simps
      list_less_tail_state_upd_def)

lemma list_less_tail_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ list_less_tail_pref) list_less_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    v \<in> vars; \<not> (prefix list_less_tail_pref v)\<rbrakk>
   \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma list_less_tail_IMP_correct_time:
  "(invoke_subprogram p list_less_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma list_less_tail_IMP_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) list_less_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (list_less_tail_imp_time 0 (list_less_tail_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using list_less_tail_IMP_correct_function list_less_tail_IMP_correct_time
  by (meson list_less_tail_IMP_correct_effects set_mono_prefix)
...
definition "concat_acc_IMP \<equiv>
...
lemma concat_acc_IMP_correct_function:
  "(invoke_subprogram p concat_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  apply(subst concat_acc_imp.simps)
  apply(simp only: concat_acc_IMP_def prefix_simps)
  apply (erule Seq_tE)+
  apply(erule While_tE)
  ...
  apply(dest_com_gen)
    ...
    subgoal
      ...
      apply(erule Seq_E)+
      apply(erule hd_IMP_correct[where vars = "concat_acc_IMP_vars"])
      subgoal premises p using p(23) by fastforce
      apply(erule reverse_nat_IMP_correct[where vars = "concat_acc_IMP_vars"])
      subgoal premises p using p(25) by fastforce
      apply(erule append_nat_IMP_correct[where vars = "concat_acc_IMP_vars"])
      subgoal premises p using p(27) by fastforce
      apply(erule tl_IMP_correct[where vars = "concat_acc_IMP_vars"])
...
lemma concat_acc_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ concat_acc_pref) concat_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
...
lemma concat_acc_IMP_correct_time:
  "(invoke_subprogram p concat_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  subgoal
    apply(simp only: prefix_simps concat_acc_IMP_init_while_cond_def
      ...
      concat_acc_state.simps
      append_nat_imp_to_HOL_state_def append_nat_imp_correct append_nat_state.simps
      append_nat_IMP_correct_time
      hd_imp_to_HOL_state_def hd_imp_correct hd_state.simps hd_IMP_correct_time
      tl_imp_to_HOL_state_def tl_imp_correct tl_state.simps tl_IMP_correct_time
      reverse_nat_imp_to_HOL_state_def reverse_nat_imp_correct reverse_nat_state.simps
      reverse_nat_IMP_correct_time
      )
      apply clarsimp
      subgoal premises p
...
lemma concat_acc_IMP_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) concat_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (concat_acc_imp_time 0 (concat_acc_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using concat_acc_IMP_correct_function
  by (auto simp: concat_acc_IMP_correct_time)
    (meson concat_acc_IMP_correct_effects set_mono_prefix)
...
definition "concat_tail_IMP \<equiv>
\<comment>\<open>concat_acc_acc' = 0;
 ...
 invoke_subprogram concat_acc_prefix concat_acc_IMP;;
...
lemma concat_tail_IMP_correct_function:
  "(invoke_subprogram p concat_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p concat_tail_ret_str)
      = concat_tail_ret
          (concat_tail_imp (concat_tail_imp_to_HOL_state p s))"
  apply (subst concat_tail_imp.simps)
  apply (simp only: concat_tail_IMP_def prefix_simps)
  apply (erule Seq_E)+
  apply (erule concat_acc_IMP_correct[where vars=concat_tail_IMP_vars])
  subgoal premises p using p(8) by fastforce
  apply (erule reverse_nat_IMP_correct[where vars=concat_tail_IMP_vars])
...
lemma concat_tail_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ concat_tail_pref) concat_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    v \<in> vars; \<not> (prefix concat_tail_pref v)\<rbrakk>
   \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma concat_tail_IMP_correct_time:
  "(invoke_subprogram p concat_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma concat_tail_IMP_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) concat_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (concat_tail_imp_time 0 (concat_tail_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using concat_tail_IMP_correct_function concat_tail_IMP_correct_time
  by (meson concat_tail_IMP_correct_effects set_mono_prefix)
...
lemma nth_nat_IMP_correct_function:
  "(invoke_subprogram p nth_nat_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  apply(subst nth_nat_imp.simps)
  apply(simp only: nth_nat_IMP_def prefix_simps)
  apply(erule Seq_E)+
  apply(erule While_tE)
  ...
  subgoal
    ...
    apply(erule Seq_E)+
    apply(erule hd_IMP_correct[where vars = "nth_nat_IMP_vars"])
  ...
  subgoal
      ...
      apply(erule Seq_E)+
      apply(erule tl_IMP_correct[where vars = "nth_nat_IMP_vars"])
      subgoal premises p using p(11) by fastforce
      apply (simp only: nth_nat_imp_subprogram_simps
          nth_nat_state_translators Let_def prefix_simps
...
lemma nth_nat_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ nth_nat_pref) nth_nat_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
...
lemma nth_nat_IMP_correct_time:
  "(invoke_subprogram p nth_nat_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  subgoal
    ...
    hd_imp_correct hd_state.simps hd_imp_to_HOL_state_def hd_IMP_correct_time)
   by force
...
lemma nth_nat_IMP_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) nth_nat_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (nth_nat_imp_time 0 (nth_nat_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using nth_nat_IMP_correct_function
  by (auto simp: nth_nat_IMP_correct_time)
    (meson nth_nat_IMP_correct_effects set_mono_prefix)
...
lemma elemof_IMP_correct_function:
  "(invoke_subprogram p elemof_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  apply(subst elemof_imp.simps)
  apply(simp only: elemof_IMP_def prefix_simps)
  apply(erule Seq_E)+
  apply(erule While_tE)
  ...
  subgoal
    ...
    apply(erule Seq_E)+
    apply(erule hd_IMP_correct[where vars = "elemof_IMP_vars"])
    subgoal premises p using p(19) by fastforce
    apply(erule NOTEQUAL_neq_zero_IMP_correct[where vars = "elemof_IMP_vars"])
    subgoal premises p using p(21) by fastforce
    apply(erule AND_neq_zero_IMP_correct[where vars = "elemof_IMP_vars"])
    subgoal premises p using p(23) by fastforce
  ...
  subgoal
    ...
    apply(erule AND_neq_zero_IMP_correct[where vars = "elemof_IMP_vars"])
    subgoal premises p using p(26) by fastforce
    apply(erule tl_IMP_correct[where vars = "elemof_IMP_vars"])
    subgoal premises p using p(28) by fastforce
...
lemma elemof_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ elemof_pref) elemof_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
...
lemma elemof_IMP_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) elemof_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (elemof_imp_time 0 (elemof_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using elemof_IMP_correct_function
    elemof_IMP_correct_time
    elemof_IMP_correct_effects
  by (meson set_mono_prefix)
...
definition remdups_acc_aux_IMP where
  "remdups_acc_aux_IMP \<equiv>
  ...
  (invoke_subprogram elemof_prefix elemof_IMP);;
...
lemma remdups_acc_aux_IMP_correct_function_acc:
  "(invoke_subprogram p remdups_acc_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p remdups_acc_aux_acc_str)
      = remdups_acc_aux_acc
          (remdups_acc_aux_imp (remdups_acc_aux_imp_to_HOL_state p s))"
  apply(subst remdups_acc_aux_imp.simps)
  apply(simp only: remdups_acc_aux_IMP_def prefix_simps)
  apply(erule Seq_E)+
  apply(erule hd_IMP_correct[where vars = "remdups_acc_aux_IMP_vars"])
  subgoal premises p using p(14) by fastforce
  apply(erule tl_IMP_correct[where vars = "remdups_acc_aux_IMP_vars"])
  subgoal premises p using p(16) by fastforce
  apply(erule elemof_IMP_correct[where vars = "remdups_acc_aux_IMP_vars"])
  ...
  subgoal
    apply(erule Seq_E)+
    apply(erule cons_IMP_correct[where vars = "remdups_acc_aux_IMP_vars"])
    subgoal premises p using p(26) by fastforce
    by (fastforce_sorted_premises2 simp: remdups_acc_aux_state_upd_def Let_def
      remdups_acc_aux_state_translators)
  done

lemma remdups_acc_aux_IMP_correct_function_n:
  "(invoke_subprogram p remdups_acc_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma remdups_acc_aux_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ remdups_acc_aux_pref) remdups_acc_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    v \<in> vars; \<not> (prefix remdups_acc_aux_pref v)\<rbrakk>
   \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma remdups_acc_aux_IMP_correct_time:
  "(invoke_subprogram p remdups_acc_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma remdups_acc_aux_IMP_correct_acc:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) remdups_acc_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (remdups_acc_aux_imp_time 0 (remdups_acc_aux_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using remdups_acc_aux_IMP_correct_function_acc
  remdups_acc_aux_IMP_correct_time
  remdups_acc_aux_IMP_correct_effects
  by (meson set_mono_prefix)

lemma remdups_acc_aux_IMP_correct_n:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) remdups_acc_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (remdups_acc_aux_imp_time 0 (remdups_acc_aux_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using remdups_acc_aux_IMP_correct_function_n
  remdups_acc_aux_IMP_correct_time
  remdups_acc_aux_IMP_correct_effects
  by (meson set_mono_prefix)

lemma remdups_acc_aux_IMP_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) remdups_acc_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (remdups_acc_aux_imp_time 0 (remdups_acc_aux_imp_to_HOL_state (p1 @ p2) s));
     s' (add_prefix (p1 @ p2) remdups_acc_aux_acc_str) =
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using remdups_acc_aux_IMP_correct_acc
  remdups_acc_aux_IMP_correct_n
...
definition "remdups_acc_IMP_loop_body \<equiv>
  ...
  (invoke_subprogram remdups_acc_aux_prefix remdups_acc_aux_IMP);;
...
definition remdups_acc_IMP where
  "remdups_acc_IMP \<equiv>
...
lemma remdups_acc_IMP_correct_function:
  "(invoke_subprogram p remdups_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  apply(subst remdups_acc_imp.simps)
  apply(simp only: remdups_acc_IMP_def prefix_simps)
  apply(erule Seq_E)+
  apply(erule While_tE)
  ...
  subgoal
      ...
      apply(erule Seq_E)+
      apply(erule remdups_acc_aux_IMP_correct[where vars = "remdups_acc_IMP_vars"])
      subgoal premises p using p(10) by fastforce
...
lemma remdups_acc_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ remdups_acc_pref) remdups_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
...
lemma remdups_acc_IMP_correct_time:
  "(invoke_subprogram p remdups_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma remdups_acc_IMP_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) remdups_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (remdups_acc_imp_time 0 (remdups_acc_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using remdups_acc_IMP_correct_function
  remdups_acc_IMP_correct_time
  remdups_acc_IMP_correct_effects
  by (meson set_mono_prefix)
...
definition remdups_tail_IMP where
  "remdups_tail_IMP \<equiv>
  ...
  (invoke_subprogram remdups_acc_prefix remdups_acc_IMP);;
...
lemma remdups_tail_IMP_correct_function:
  "(invoke_subprogram p remdups_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p remdups_tail_ret_str)
      = remdups_tail_ret
          (remdups_tail_imp (remdups_tail_imp_to_HOL_state p s))"
  apply(subst remdups_tail_imp.simps)
  apply(simp only: remdups_tail_IMP_def prefix_simps)
  apply(erule Seq_E)+
  apply(erule remdups_acc_IMP_correct[where vars = "remdups_tail_IMP_vars"])
  subgoal premises p using p(8) by fastforce
  apply(erule reverse_nat_IMP_correct[where vars = "remdups_tail_IMP_vars"])
  subgoal premises p using p(10) by fastforce
  by (fastforce simp: remdups_tail_state_translators remdups_tail_state_upd_def)

lemma remdups_tail_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ remdups_tail_pref) remdups_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    v \<in> vars; \<not> (prefix remdups_tail_pref v)\<rbrakk>
   \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma remdups_tail_IMP_correct_time:
  "(invoke_subprogram p remdups_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma remdups_tail_IMP_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) remdups_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (remdups_tail_imp_time 0 (remdups_tail_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using remdups_tail_IMP_correct_function
    remdups_tail_IMP_correct_time
    remdups_tail_IMP_correct_effects
  by (meson set_mono_prefix)
...
definition "restrict_aux_IMP \<equiv>
  \<comment> \<open>let\<close>
...
lemma restrict_aux_IMP_correct_function_acc:
  "(invoke_subprogram p restrict_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p restrict_aux_acc_str)
      = restrict_aux_acc
          (restrict_aux_imp (restrict_aux_imp_to_HOL_state p s))"
  apply (subst restrict_aux_imp.simps)
  apply (simp only: restrict_aux_IMP_def prefix_simps)
  apply (erule Seq_E)+
  apply (erule hd_IMP_correct[where vars=restrict_aux_IMP_vars])
  subgoal premises p using p(17) by fastforce
  apply (erule tl_IMP_correct[where vars=restrict_aux_IMP_vars])
  subgoal premises p using p(19) by fastforce
  apply (erule fst'_IMP_correct[where vars=restrict_aux_IMP_vars])
  subgoal premises p using p(21) by fastforce
  apply (erule elemof_IMP_correct[where vars=restrict_aux_IMP_vars])
  subgoal premises p using p(23) by fastforce
  apply (erule If_E)
  subgoal
    apply (erule Seq_E)+
    apply (erule cons_IMP_correct[where vars=restrict_aux_IMP_vars])
    subgoal premises p using p(31) by fastforce
...
lemma restrict_aux_IMP_correct_function_l:
  "(invoke_subprogram p restrict_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma restrict_aux_IMP_correct_function_s:
  "(invoke_subprogram p restrict_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma restrict_aux_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ restrict_aux_pref) restrict_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    v \<in> vars; \<not> (prefix restrict_aux_pref v)\<rbrakk>
   \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma restrict_aux_IMP_correct_time:
  "(invoke_subprogram p restrict_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma restrict_aux_IMP_correct_acc:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) restrict_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (restrict_aux_imp_time 0 (restrict_aux_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using restrict_aux_IMP_correct_function_acc
  by (auto simp: restrict_aux_IMP_correct_time)
    (meson restrict_aux_IMP_correct_effects set_mono_prefix)

lemma restrict_aux_IMP_correct_l:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) restrict_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (restrict_aux_imp_time 0 (restrict_aux_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using restrict_aux_IMP_correct_function_l
  by (auto simp: restrict_aux_IMP_correct_time)
    (meson restrict_aux_IMP_correct_effects set_mono_prefix)

lemma restrict_aux_IMP_correct_s:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) restrict_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (restrict_aux_imp_time 0 (restrict_aux_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using restrict_aux_IMP_correct_function_s
  by (auto simp: restrict_aux_IMP_correct_time)
    (meson restrict_aux_IMP_correct_effects set_mono_prefix)

lemma restrict_aux_IMP_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) restrict_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (restrict_aux_imp_time 0 (restrict_aux_imp_to_HOL_state (p1 @ p2) s));
     s' (add_prefix (p1 @ p2) restrict_aux_acc_str) =
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
   using restrict_aux_IMP_correct_acc
     restrict_aux_IMP_correct_l restrict_aux_IMP_correct_s
     by (smt (verit, del_insts))
...
definition "restrict_acc_IMP_loop_body \<equiv>
  ...
  invoke_subprogram restrict_aux_prefix restrict_aux_IMP;;
...
definition restrict_acc_IMP where
  "restrict_acc_IMP \<equiv>
...
lemma restrict_acc_IMP_correct_function:
  "(invoke_subprogram p restrict_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  apply(subst restrict_acc_imp.simps)
  apply(simp only: restrict_acc_IMP_def prefix_simps)
  apply(erule Seq_E)+
  apply(erule While_tE)
  ...
  subgoal
      ...
      apply(erule Seq_E)+
      apply(erule restrict_aux_IMP_correct[where vars = "restrict_acc_IMP_vars"])
...
lemma restrict_acc_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ restrict_acc_pref) restrict_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
...
lemma restrict_acc_IMP_correct_time:
  "(invoke_subprogram p restrict_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma restrict_acc_IMP_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) restrict_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (restrict_acc_imp_time 0 (restrict_acc_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using restrict_acc_IMP_correct_function
  by (auto simp: restrict_acc_IMP_correct_time)
    (meson restrict_acc_IMP_correct_effects set_mono_prefix)
...
definition "restrict_tail_IMP \<equiv>
  ...
  invoke_subprogram restrict_acc_prefix restrict_acc_IMP;;
...
lemma restrict_tail_IMP_correct_function:
  "(invoke_subprogram p restrict_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p restrict_tail_ret_str)
      = restrict_tail_ret
          (restrict_tail_imp (restrict_tail_imp_to_HOL_state p s))"
  apply (subst restrict_tail_imp.simps)
  apply (simp only: restrict_tail_IMP_def prefix_simps)
  apply (erule Seq_E)+
  apply (erule restrict_acc_IMP_correct[where vars=restrict_tail_IMP_vars])
  subgoal premises p using p(9) by fastforce
  apply (erule reverse_nat_IMP_correct[where vars=restrict_tail_IMP_vars])
  subgoal premises p using p(11) by fastforce
  apply (force simp: restrict_tail_state_upd_def
  restrict_tail_state_translators Let_def)
  done

lemma restrict_tail_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ restrict_tail_pref) restrict_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    v \<in> vars; \<not> (prefix restrict_tail_pref v)\<rbrakk>
   \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma restrict_tail_IMP_correct_time:
  "(invoke_subprogram p restrict_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma restrict_tail_IMP_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) restrict_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (restrict_tail_imp_time 0 (restrict_tail_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using restrict_tail_IMP_correct_function restrict_tail_IMP_correct_time
  by (meson restrict_tail_IMP_correct_effects set_mono_prefix)
...
definition BigAnd_aux_IMP where
  "BigAnd_aux_IMP \<equiv>
...
lemma BigAnd_aux_IMP_correct_function:
  "(invoke_subprogram p BigAnd_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p BigAnd_aux_ret_str)
      = BigAnd_aux_ret
          (BigAnd_aux_imp (BigAnd_aux_imp_to_HOL_state p s))"
  apply(subst BigAnd_aux_imp.simps)
  apply(simp only: BigAnd_aux_IMP_def prefix_simps)
  apply(erule Seq_E)+
  apply (erule  cons_IMP_correct[where vars=BigAnd_aux_IMP_vars])
  subgoal premises p using p(16) by fastforce
  apply (erule hd_IMP_correct[where vars="BigAnd_aux_IMP_vars \<union> {cons_prefix @ cons_ret_str}"])
  subgoal premises p using p(18) by fastforce
  apply (erule  cons_IMP_correct[where vars=BigAnd_aux_IMP_vars])
  subgoal premises p using p(20) by fastforce
  apply (erule  cons_IMP_correct[where vars=BigAnd_aux_IMP_vars])
...
lemma BigAnd_aux_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ BigAnd_aux_pref) BigAnd_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
...
lemma BigAnd_aux_IMP_correct_time:
  "(invoke_subprogram p BigAnd_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma BigAnd_aux_IMP_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) BigAnd_aux_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (BigAnd_aux_imp_time 0 (BigAnd_aux_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using BigAnd_aux_IMP_correct_function
  by (auto simp: BigAnd_aux_IMP_correct_time)
    (meson BigAnd_aux_IMP_correct_effects set_mono_prefix)
...
definition "BigAnd_acc_IMP_loop_body \<equiv>
  \<comment> \<open>BigAnd_aux_acc' = BigAnd_acc_acc s;
    ...
    invoke_subprogram BigAnd_aux_prefix BigAnd_aux_IMP;;
...
definition BigAnd_acc_IMP where
  "BigAnd_acc_IMP \<equiv>
...
lemma BigAnd_acc_IMP_correct_function:
  "(invoke_subprogram p BigAnd_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
  ...
  apply(subst BigAnd_acc_imp.simps)
  apply(simp only: BigAnd_acc_IMP_def prefix_simps)
  apply(erule Seq_E)+
  apply(erule While_tE)
  ...
  subgoal
      ...
      apply(erule Seq_E)+
      apply(erule tl_IMP_correct[where vars = "BigAnd_acc_IMP_vars"])
      subgoal premises p using p(14) by fastforce
      apply(erule BigAnd_aux_IMP_correct[where vars = "BigAnd_acc_IMP_vars"])
      subgoal premises p using p(16) by fastforce
...
lemma BigAnd_acc_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ BigAnd_acc_pref) BigAnd_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
...
lemma BigAnd_acc_IMP_correct_time:
  "(invoke_subprogram p BigAnd_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma BigAnd_acc_IMP_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) BigAnd_acc_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (BigAnd_acc_imp_time 0 (BigAnd_acc_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using BigAnd_acc_IMP_correct_function
  by (auto simp: BigAnd_acc_IMP_correct_time)
    (meson BigAnd_acc_IMP_correct_effects set_mono_prefix)
...
definition "BigAnd_tail_IMP \<equiv>
\<comment>\<open>cons_h' = 0;
  ...
  invoke_subprogram BigAnd_acc_prefix BigAnd_acc_IMP;;
...
lemma BigAnd_tail_IMP_correct_function:
  "(invoke_subprogram p BigAnd_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p BigAnd_tail_ret_str)
      = BigAnd_tail_ret
          (BigAnd_tail_imp (BigAnd_tail_imp_to_HOL_state p s))"
  apply (subst BigAnd_tail_imp.simps)
  apply (simp only: BigAnd_tail_IMP_def prefix_simps)
  apply (erule Seq_E)+
  apply (erule cons_IMP_correct[where vars=BigAnd_tail_IMP_vars])
  subgoal premises p using p(20) by fastforce
  apply (erule cons_IMP_correct[where vars=BigAnd_tail_IMP_vars])
  subgoal premises p using p(22) by fastforce
  apply (erule cons_IMP_correct[where vars=BigAnd_tail_IMP_vars])
  subgoal premises p using p(24) by fastforce
  apply (erule reverse_nat_IMP_correct[where vars="BigAnd_tail_IMP_vars
  \<union> {cons_prefix @ cons_ret_str}"])
  subgoal premises p using p(26) by fastforce
  apply (erule BigAnd_acc_IMP_correct[where vars=BigAnd_tail_IMP_vars])
  subgoal premises p using p(28) by fastforce
  apply (force simp: BigAnd_tail_state_upd_def
  BigAnd_tail_state_translators Let_def)
  done

lemma BigAnd_tail_IMP_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ BigAnd_tail_prefix) BigAnd_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    v \<in> vars; \<not> (prefix BigAnd_tail_prefix v)\<rbrakk>
   \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma BigAnd_tail_IMP_correct_time:
  "(invoke_subprogram p BigAnd_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
...
lemma BigAnd_tail_IMP_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) BigAnd_tail_IMP, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (BigAnd_tail_imp_time 0 (BigAnd_tail_imp_to_HOL_state (p1 @ p2) s));
     ...
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using BigAnd_tail_IMP_correct_function BigAnd_tail_IMP_correct_time
  BigAnd_tail_IMP_correct_effects
