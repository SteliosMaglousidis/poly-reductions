...
theorem is_reduction_xc_to_ehs: "is_reduction xc_to_ehs exact_cover exact_hitting_set"
  using xc_to_ehs_sound xc_to_ehs_complete by (intro is_reductionI) auto
