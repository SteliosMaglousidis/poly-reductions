...
lemma chromatik_card1:"ugraph E \<Longrightarrow> card {{(v1, 0::nat), (v2, 0)} |v1 v2. {v1, v2} \<in> E} =  card E"
...
lemma split_nats: "k \<in> {1.. (Suc x)} \<longleftrightarrow> k \<in> {1..(x)} \<or> k = Suc x"
